...
export const OptionalParams: MessageFns<OptionalParams> = {
  encode(message: OptionalParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.maxTopicsPerBlock) {
      writer.uint64(v);
    }
    writer.join();
    ...
    for (const v of message.maxRetriesToFulfilNoncesWorker) {
      writer.int64(v);
    }
    writer.join();
    writer.uint32(218).fork();
    for (const v of message.maxRetriesToFulfilNoncesReputer) {
      writer.int64(v);
    }
    writer.join();
    ...
    for (const v of message.topicFeeRevenueDecayRate) {
      writer.uint32(314).string(v!);
    }
    for (const v of message.epsilonReputer) {
      writer.uint32(322).string(v!);
    }
    for (const v of message.minEffectiveTopicRevenue) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): OptionalParams {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          if (tag === 32) {
            message.maxTopicsPerBlock.push(reader.uint64().toString());
        ...
        case 26: {
          if (tag === 208) {
            message.maxRetriesToFulfilNoncesWorker.push(reader.int64().toString());
        ...
        case 27: {
          if (tag === 216) {
            message.maxRetriesToFulfilNoncesReputer.push(reader.int64().toString());
        ...
        case 39: {
          ...
          message.topicFeeRevenueDecayRate.push(reader.string());
          continue;
        }
        case 40: {
          if (tag !== 322) {
        ...
        case 41: {
          ...
          message.minEffectiveTopicRevenue.push(reader.string());
          continue;
        }
        case 42: {
          if (tag === 336) {
  ...
  fromJSON(object: any): OptionalParams {
    return {
      ...
      minTopicWeight: globalThis.Array.isArray(object?.minTopicWeight)
        ...
        : [],
      maxTopicsPerBlock: globalThis.Array.isArray(object?.maxTopicsPerBlock)
        ? object.maxTopicsPerBlock.map((e: any) => globalThis.String(e))
        : [],
      ...
      gradientDescentMaxIters: globalThis.Array.isArray(object?.gradientDescentMaxIters)
        ...
        : [],
      maxRetriesToFulfilNoncesWorker: globalThis.Array.isArray(object?.maxRetriesToFulfilNoncesWorker)
        ? object.maxRetriesToFulfilNoncesWorker.map((e: any) => globalThis.String(e))
        : [],
      maxRetriesToFulfilNoncesReputer: globalThis.Array.isArray(object?.maxRetriesToFulfilNoncesReputer)
        ? object.maxRetriesToFulfilNoncesReputer.map((e: any) => globalThis.String(e))
        : [],
      ...
      cRewardForecast: globalThis.Array.isArray(object?.cRewardForecast)
        ...
        : [],
      cNorm: globalThis.Array.isArray(object?.cNorm)
        ? object.cNorm.map((e: any) => globalThis.String(e))
        : [],
      topicFeeRevenueDecayRate: globalThis.Array.isArray(object?.topicFeeRevenueDecayRate)
        ? object.topicFeeRevenueDecayRate.map((e: any) => globalThis.String(e))
        : [],
      epsilonReputer: globalThis.Array.isArray(object?.epsilonReputer)
        ? object.epsilonReputer.map((e: any) => globalThis.String(e))
        : [],
      minEffectiveTopicRevenue: globalThis.Array.isArray(object?.minEffectiveTopicRevenue)
        ? object.minEffectiveTopicRevenue.map((e: any) => globalThis.String(e))
        : [],
  ...
  toJSON(message: OptionalParams): unknown {
    ...
    if (message.maxTopicsPerBlock?.length) {
    ...
    if (message.maxRetriesToFulfilNoncesWorker?.length) {
      obj.maxRetriesToFulfilNoncesWorker = message.maxRetriesToFulfilNoncesWorker;
    }
    if (message.maxRetriesToFulfilNoncesReputer?.length) {
    ...
    if (message.topicFeeRevenueDecayRate?.length) {
    ...
    if (message.minEffectiveTopicRevenue?.length) {
  ...
  fromPartial(object: DeepPartial<OptionalParams>): OptionalParams {
    ...
    message.maxTopicsPerBlock = object.maxTopicsPerBlock?.map((e) => e) || [];
    ...
    message.maxRetriesToFulfilNoncesWorker = object.maxRetriesToFulfilNoncesWorker?.map((e) => e) || [];
    message.maxRetriesToFulfilNoncesReputer = object.maxRetriesToFulfilNoncesReputer?.map((e) => e) || [];
    ...
    message.topicFeeRevenueDecayRate = object.topicFeeRevenueDecayRate?.map((e) => e) || [];
    message.epsilonReputer = object.epsilonReputer?.map((e) => e) || [];
    message.minEffectiveTopicRevenue = object.minEffectiveTopicRevenue?.map((e) => e) || [];
...
export const MsgServiceName = "emissions.v2.Msg";
