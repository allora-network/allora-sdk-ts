...
export interface IsWhitelistedGlobalWorkerRequest {
  address: string;
}

export interface IsWhitelistedGlobalWorkerResponse {
  isWhitelistedGlobalWorker: boolean;
}

export interface IsWhitelistedGlobalReputerRequest {
  address: string;
}

export interface IsWhitelistedGlobalReputerResponse {
  isWhitelistedGlobalReputer: boolean;
}

export interface IsWhitelistedGlobalAdminRequest {
  address: string;
}

export interface IsWhitelistedGlobalAdminResponse {
  isWhitelistedGlobalAdmin: boolean;
}

export interface IsTopicWorkerWhitelistEnabledRequest {
  topicId: string;
}

export interface IsTopicWorkerWhitelistEnabledResponse {
  isTopicWorkerWhitelistEnabled: boolean;
}

export interface IsTopicReputerWhitelistEnabledRequest {
  topicId: string;
}

export interface IsTopicReputerWhitelistEnabledResponse {
  isTopicReputerWhitelistEnabled: boolean;
}

export interface IsWhitelistedTopicCreatorRequest {
  address: string;
}

export interface IsWhitelistedTopicCreatorResponse {
  isWhitelistedTopicCreator: boolean;
}

export interface IsWhitelistedGlobalActorRequest {
  address: string;
}

export interface IsWhitelistedGlobalActorResponse {
  isWhitelistedGlobalActor: boolean;
}

export interface IsWhitelistedTopicWorkerRequest {
  topicId: string;
  address: string;
}

export interface IsWhitelistedTopicWorkerResponse {
  isWhitelistedTopicWorker: boolean;
}

export interface IsWhitelistedTopicReputerRequest {
  topicId: string;
  address: string;
}

export interface IsWhitelistedTopicReputerResponse {
  isWhitelistedTopicReputer: boolean;
}

export interface CanUpdateAllGlobalWhitelistsRequest {
  address: string;
}

export interface CanUpdateAllGlobalWhitelistsResponse {
  canUpdateAllGlobalWhitelists: boolean;
}

export interface CanUpdateGlobalWorkerWhitelistRequest {
  address: string;
}

export interface CanUpdateGlobalWorkerWhitelistResponse {
  canUpdateGlobalWorkerWhitelist: boolean;
}

export interface CanUpdateGlobalReputerWhitelistRequest {
  address: string;
}

export interface CanUpdateGlobalReputerWhitelistResponse {
  canUpdateGlobalReputerWhitelist: boolean;
}

export interface CanUpdateParamsRequest {
  address: string;
}

export interface CanUpdateParamsResponse {
  canUpdateParams: boolean;
}

export interface CanUpdateTopicWhitelistRequest {
  topicId: string;
  address: string;
}

export interface CanUpdateTopicWhitelistResponse {
  canUpdateTopicWhitelist: boolean;
}

export interface CanCreateTopicRequest {
  address: string;
}

export interface CanCreateTopicResponse {
  canCreateTopic: boolean;
}

export interface CanSubmitWorkerPayloadRequest {
  topicId: string;
  address: string;
}

export interface CanSubmitWorkerPayloadResponse {
  canSubmitWorkerPayload: boolean;
}

export interface CanSubmitReputerPayloadRequest {
  topicId: string;
  address: string;
}

export interface CanSubmitReputerPayloadResponse {
  canSubmitReputerPayload: boolean;
}
...
export interface GetNetworkInferencesAtBlockOutlierResistantRequest {
  topicId: string;
  blockHeightLastInference: string;
}
...
export interface GetLatestNetworkInferencesOutlierResistantRequest {
  topicId: string;
}
...
export interface GetLatestAvailableNetworkInferencesOutlierResistantRequest {
  topicId: string;
}
...
export interface GetNetworkInferencesAtBlockOutlierResistantResponse {
  networkInferences?: ValueBundle | undefined;
}
...
export interface GetLatestNetworkInferencesOutlierResistantResponse {
  networkInferences?: ValueBundle | undefined;
  infererWeights: RegretInformedWeight[];
  forecasterWeights: RegretInformedWeight[];
  inferenceBlockHeight: string;
...
export interface GetLatestAvailableNetworkInferencesOutlierResistantResponse {
  networkInferences?: ValueBundle | undefined;
  infererWeights: RegretInformedWeight[];
  forecasterWeights: RegretInformedWeight[];
  inferenceBlockHeight: string;
...
export interface GetTopicInitialInfererEmaScoreRequest {
  topicId: string;
}

export interface GetTopicInitialInfererEmaScoreResponse {
  score: string;
}

export interface GetTopicInitialForecasterEmaScoreRequest {
  topicId: string;
}

export interface GetTopicInitialForecasterEmaScoreResponse {
  score: string;
}

export interface GetTopicInitialReputerEmaScoreRequest {
  topicId: string;
}

export interface GetTopicInitialReputerEmaScoreResponse {
  score: string;
}

function createBaseIsWhitelistedGlobalWorkerRequest(): IsWhitelistedGlobalWorkerRequest {
  return { address: "" };
}

export const IsWhitelistedGlobalWorkerRequest: MessageFns<IsWhitelistedGlobalWorkerRequest> = {
  encode(message: IsWhitelistedGlobalWorkerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalWorkerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalWorkerRequest();
  ...
  fromJSON(object: any): IsWhitelistedGlobalWorkerRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: IsWhitelistedGlobalWorkerRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
  ...
  create(base?: DeepPartial<IsWhitelistedGlobalWorkerRequest>): IsWhitelistedGlobalWorkerRequest {
    return IsWhitelistedGlobalWorkerRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalWorkerRequest>): IsWhitelistedGlobalWorkerRequest {
    const message = createBaseIsWhitelistedGlobalWorkerRequest();
...
function createBaseIsWhitelistedGlobalWorkerResponse(): IsWhitelistedGlobalWorkerResponse {
  return { isWhitelistedGlobalWorker: false };
}

export const IsWhitelistedGlobalWorkerResponse: MessageFns<IsWhitelistedGlobalWorkerResponse> = {
  encode(message: IsWhitelistedGlobalWorkerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isWhitelistedGlobalWorker !== false) {
      writer.uint32(8).bool(message.isWhitelistedGlobalWorker);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalWorkerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalWorkerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isWhitelistedGlobalWorker = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsWhitelistedGlobalWorkerResponse {
    return {
      isWhitelistedGlobalWorker: isSet(object.isWhitelistedGlobalWorker)
        ? globalThis.Boolean(object.isWhitelistedGlobalWorker)
        : false,
    };
  },

  toJSON(message: IsWhitelistedGlobalWorkerResponse): unknown {
    const obj: any = {};
    if (message.isWhitelistedGlobalWorker !== false) {
      obj.isWhitelistedGlobalWorker = message.isWhitelistedGlobalWorker;
    }
    return obj;
  },

  create(base?: DeepPartial<IsWhitelistedGlobalWorkerResponse>): IsWhitelistedGlobalWorkerResponse {
    return IsWhitelistedGlobalWorkerResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalWorkerResponse>): IsWhitelistedGlobalWorkerResponse {
    const message = createBaseIsWhitelistedGlobalWorkerResponse();
    message.isWhitelistedGlobalWorker = object.isWhitelistedGlobalWorker ?? false;
    return message;
  },
};

function createBaseIsWhitelistedGlobalReputerRequest(): IsWhitelistedGlobalReputerRequest {
  return { address: "" };
}

export const IsWhitelistedGlobalReputerRequest: MessageFns<IsWhitelistedGlobalReputerRequest> = {
  encode(message: IsWhitelistedGlobalReputerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalReputerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalReputerRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsWhitelistedGlobalReputerRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: IsWhitelistedGlobalReputerRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<IsWhitelistedGlobalReputerRequest>): IsWhitelistedGlobalReputerRequest {
    return IsWhitelistedGlobalReputerRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalReputerRequest>): IsWhitelistedGlobalReputerRequest {
    const message = createBaseIsWhitelistedGlobalReputerRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseIsWhitelistedGlobalReputerResponse(): IsWhitelistedGlobalReputerResponse {
  return { isWhitelistedGlobalReputer: false };
}

export const IsWhitelistedGlobalReputerResponse: MessageFns<IsWhitelistedGlobalReputerResponse> = {
  encode(message: IsWhitelistedGlobalReputerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isWhitelistedGlobalReputer !== false) {
      writer.uint32(8).bool(message.isWhitelistedGlobalReputer);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalReputerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalReputerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isWhitelistedGlobalReputer = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsWhitelistedGlobalReputerResponse {
    return {
      isWhitelistedGlobalReputer: isSet(object.isWhitelistedGlobalReputer)
        ? globalThis.Boolean(object.isWhitelistedGlobalReputer)
        : false,
    };
  },

  toJSON(message: IsWhitelistedGlobalReputerResponse): unknown {
    const obj: any = {};
    if (message.isWhitelistedGlobalReputer !== false) {
      obj.isWhitelistedGlobalReputer = message.isWhitelistedGlobalReputer;
    }
    return obj;
  },

  create(base?: DeepPartial<IsWhitelistedGlobalReputerResponse>): IsWhitelistedGlobalReputerResponse {
    return IsWhitelistedGlobalReputerResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalReputerResponse>): IsWhitelistedGlobalReputerResponse {
    const message = createBaseIsWhitelistedGlobalReputerResponse();
    message.isWhitelistedGlobalReputer = object.isWhitelistedGlobalReputer ?? false;
    return message;
  },
};

function createBaseIsWhitelistedGlobalAdminRequest(): IsWhitelistedGlobalAdminRequest {
  return { address: "" };
}

export const IsWhitelistedGlobalAdminRequest: MessageFns<IsWhitelistedGlobalAdminRequest> = {
  encode(message: IsWhitelistedGlobalAdminRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalAdminRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalAdminRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsWhitelistedGlobalAdminRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: IsWhitelistedGlobalAdminRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<IsWhitelistedGlobalAdminRequest>): IsWhitelistedGlobalAdminRequest {
    return IsWhitelistedGlobalAdminRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalAdminRequest>): IsWhitelistedGlobalAdminRequest {
    const message = createBaseIsWhitelistedGlobalAdminRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseIsWhitelistedGlobalAdminResponse(): IsWhitelistedGlobalAdminResponse {
  return { isWhitelistedGlobalAdmin: false };
}

export const IsWhitelistedGlobalAdminResponse: MessageFns<IsWhitelistedGlobalAdminResponse> = {
  encode(message: IsWhitelistedGlobalAdminResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isWhitelistedGlobalAdmin !== false) {
      writer.uint32(8).bool(message.isWhitelistedGlobalAdmin);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalAdminResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalAdminResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isWhitelistedGlobalAdmin = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsWhitelistedGlobalAdminResponse {
    return {
      isWhitelistedGlobalAdmin: isSet(object.isWhitelistedGlobalAdmin)
        ? globalThis.Boolean(object.isWhitelistedGlobalAdmin)
        : false,
    };
  },

  toJSON(message: IsWhitelistedGlobalAdminResponse): unknown {
    const obj: any = {};
    if (message.isWhitelistedGlobalAdmin !== false) {
      obj.isWhitelistedGlobalAdmin = message.isWhitelistedGlobalAdmin;
    }
    return obj;
  },

  create(base?: DeepPartial<IsWhitelistedGlobalAdminResponse>): IsWhitelistedGlobalAdminResponse {
    return IsWhitelistedGlobalAdminResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalAdminResponse>): IsWhitelistedGlobalAdminResponse {
    const message = createBaseIsWhitelistedGlobalAdminResponse();
    message.isWhitelistedGlobalAdmin = object.isWhitelistedGlobalAdmin ?? false;
    return message;
  },
};

function createBaseIsTopicWorkerWhitelistEnabledRequest(): IsTopicWorkerWhitelistEnabledRequest {
  return { topicId: "0" };
}

export const IsTopicWorkerWhitelistEnabledRequest: MessageFns<IsTopicWorkerWhitelistEnabledRequest> = {
  encode(message: IsTopicWorkerWhitelistEnabledRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsTopicWorkerWhitelistEnabledRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsTopicWorkerWhitelistEnabledRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsTopicWorkerWhitelistEnabledRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: IsTopicWorkerWhitelistEnabledRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
  ...
  create(base?: DeepPartial<IsTopicWorkerWhitelistEnabledRequest>): IsTopicWorkerWhitelistEnabledRequest {
    return IsTopicWorkerWhitelistEnabledRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsTopicWorkerWhitelistEnabledRequest>): IsTopicWorkerWhitelistEnabledRequest {
    const message = createBaseIsTopicWorkerWhitelistEnabledRequest();
...
function createBaseIsTopicWorkerWhitelistEnabledResponse(): IsTopicWorkerWhitelistEnabledResponse {
  return { isTopicWorkerWhitelistEnabled: false };
}

export const IsTopicWorkerWhitelistEnabledResponse: MessageFns<IsTopicWorkerWhitelistEnabledResponse> = {
  encode(message: IsTopicWorkerWhitelistEnabledResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isTopicWorkerWhitelistEnabled !== false) {
      writer.uint32(8).bool(message.isTopicWorkerWhitelistEnabled);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsTopicWorkerWhitelistEnabledResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsTopicWorkerWhitelistEnabledResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isTopicWorkerWhitelistEnabled = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsTopicWorkerWhitelistEnabledResponse {
    return {
      isTopicWorkerWhitelistEnabled: isSet(object.isTopicWorkerWhitelistEnabled)
        ? globalThis.Boolean(object.isTopicWorkerWhitelistEnabled)
        : false,
    };
  },

  toJSON(message: IsTopicWorkerWhitelistEnabledResponse): unknown {
    const obj: any = {};
    if (message.isTopicWorkerWhitelistEnabled !== false) {
      obj.isTopicWorkerWhitelistEnabled = message.isTopicWorkerWhitelistEnabled;
    }
    return obj;
  },

  create(base?: DeepPartial<IsTopicWorkerWhitelistEnabledResponse>): IsTopicWorkerWhitelistEnabledResponse {
    return IsTopicWorkerWhitelistEnabledResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsTopicWorkerWhitelistEnabledResponse>): IsTopicWorkerWhitelistEnabledResponse {
    const message = createBaseIsTopicWorkerWhitelistEnabledResponse();
    message.isTopicWorkerWhitelistEnabled = object.isTopicWorkerWhitelistEnabled ?? false;
    return message;
  },
};

function createBaseIsTopicReputerWhitelistEnabledRequest(): IsTopicReputerWhitelistEnabledRequest {
  return { topicId: "0" };
}

export const IsTopicReputerWhitelistEnabledRequest: MessageFns<IsTopicReputerWhitelistEnabledRequest> = {
  encode(message: IsTopicReputerWhitelistEnabledRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsTopicReputerWhitelistEnabledRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsTopicReputerWhitelistEnabledRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsTopicReputerWhitelistEnabledRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: IsTopicReputerWhitelistEnabledRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<IsTopicReputerWhitelistEnabledRequest>): IsTopicReputerWhitelistEnabledRequest {
    return IsTopicReputerWhitelistEnabledRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsTopicReputerWhitelistEnabledRequest>): IsTopicReputerWhitelistEnabledRequest {
    const message = createBaseIsTopicReputerWhitelistEnabledRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseIsTopicReputerWhitelistEnabledResponse(): IsTopicReputerWhitelistEnabledResponse {
  return { isTopicReputerWhitelistEnabled: false };
}

export const IsTopicReputerWhitelistEnabledResponse: MessageFns<IsTopicReputerWhitelistEnabledResponse> = {
  encode(message: IsTopicReputerWhitelistEnabledResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isTopicReputerWhitelistEnabled !== false) {
      writer.uint32(8).bool(message.isTopicReputerWhitelistEnabled);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsTopicReputerWhitelistEnabledResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsTopicReputerWhitelistEnabledResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isTopicReputerWhitelistEnabled = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsTopicReputerWhitelistEnabledResponse {
    return {
      isTopicReputerWhitelistEnabled: isSet(object.isTopicReputerWhitelistEnabled)
        ? globalThis.Boolean(object.isTopicReputerWhitelistEnabled)
        : false,
    };
  },

  toJSON(message: IsTopicReputerWhitelistEnabledResponse): unknown {
    const obj: any = {};
    if (message.isTopicReputerWhitelistEnabled !== false) {
      obj.isTopicReputerWhitelistEnabled = message.isTopicReputerWhitelistEnabled;
    }
    return obj;
  },

  create(base?: DeepPartial<IsTopicReputerWhitelistEnabledResponse>): IsTopicReputerWhitelistEnabledResponse {
    return IsTopicReputerWhitelistEnabledResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsTopicReputerWhitelistEnabledResponse>): IsTopicReputerWhitelistEnabledResponse {
    const message = createBaseIsTopicReputerWhitelistEnabledResponse();
    message.isTopicReputerWhitelistEnabled = object.isTopicReputerWhitelistEnabled ?? false;
    return message;
  },
};

function createBaseIsWhitelistedTopicCreatorRequest(): IsWhitelistedTopicCreatorRequest {
  return { address: "" };
}

export const IsWhitelistedTopicCreatorRequest: MessageFns<IsWhitelistedTopicCreatorRequest> = {
  encode(message: IsWhitelistedTopicCreatorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedTopicCreatorRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedTopicCreatorRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsWhitelistedTopicCreatorRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: IsWhitelistedTopicCreatorRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<IsWhitelistedTopicCreatorRequest>): IsWhitelistedTopicCreatorRequest {
    return IsWhitelistedTopicCreatorRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedTopicCreatorRequest>): IsWhitelistedTopicCreatorRequest {
    const message = createBaseIsWhitelistedTopicCreatorRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseIsWhitelistedTopicCreatorResponse(): IsWhitelistedTopicCreatorResponse {
  return { isWhitelistedTopicCreator: false };
}

export const IsWhitelistedTopicCreatorResponse: MessageFns<IsWhitelistedTopicCreatorResponse> = {
  encode(message: IsWhitelistedTopicCreatorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isWhitelistedTopicCreator !== false) {
      writer.uint32(8).bool(message.isWhitelistedTopicCreator);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedTopicCreatorResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedTopicCreatorResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isWhitelistedTopicCreator = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsWhitelistedTopicCreatorResponse {
    return {
      isWhitelistedTopicCreator: isSet(object.isWhitelistedTopicCreator)
        ? globalThis.Boolean(object.isWhitelistedTopicCreator)
        : false,
    };
  },

  toJSON(message: IsWhitelistedTopicCreatorResponse): unknown {
    const obj: any = {};
    if (message.isWhitelistedTopicCreator !== false) {
      obj.isWhitelistedTopicCreator = message.isWhitelistedTopicCreator;
    }
    return obj;
  },

  create(base?: DeepPartial<IsWhitelistedTopicCreatorResponse>): IsWhitelistedTopicCreatorResponse {
    return IsWhitelistedTopicCreatorResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedTopicCreatorResponse>): IsWhitelistedTopicCreatorResponse {
    const message = createBaseIsWhitelistedTopicCreatorResponse();
    message.isWhitelistedTopicCreator = object.isWhitelistedTopicCreator ?? false;
    return message;
  },
};

function createBaseIsWhitelistedGlobalActorRequest(): IsWhitelistedGlobalActorRequest {
  return { address: "" };
}

export const IsWhitelistedGlobalActorRequest: MessageFns<IsWhitelistedGlobalActorRequest> = {
  encode(message: IsWhitelistedGlobalActorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalActorRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalActorRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsWhitelistedGlobalActorRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: IsWhitelistedGlobalActorRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<IsWhitelistedGlobalActorRequest>): IsWhitelistedGlobalActorRequest {
    return IsWhitelistedGlobalActorRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalActorRequest>): IsWhitelistedGlobalActorRequest {
    const message = createBaseIsWhitelistedGlobalActorRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseIsWhitelistedGlobalActorResponse(): IsWhitelistedGlobalActorResponse {
  return { isWhitelistedGlobalActor: false };
}

export const IsWhitelistedGlobalActorResponse: MessageFns<IsWhitelistedGlobalActorResponse> = {
  encode(message: IsWhitelistedGlobalActorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isWhitelistedGlobalActor !== false) {
      writer.uint32(8).bool(message.isWhitelistedGlobalActor);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedGlobalActorResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedGlobalActorResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isWhitelistedGlobalActor = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsWhitelistedGlobalActorResponse {
    return {
      isWhitelistedGlobalActor: isSet(object.isWhitelistedGlobalActor)
        ? globalThis.Boolean(object.isWhitelistedGlobalActor)
        : false,
    };
  },

  toJSON(message: IsWhitelistedGlobalActorResponse): unknown {
    const obj: any = {};
    if (message.isWhitelistedGlobalActor !== false) {
      obj.isWhitelistedGlobalActor = message.isWhitelistedGlobalActor;
    }
    return obj;
  },

  create(base?: DeepPartial<IsWhitelistedGlobalActorResponse>): IsWhitelistedGlobalActorResponse {
    return IsWhitelistedGlobalActorResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedGlobalActorResponse>): IsWhitelistedGlobalActorResponse {
    const message = createBaseIsWhitelistedGlobalActorResponse();
    message.isWhitelistedGlobalActor = object.isWhitelistedGlobalActor ?? false;
    return message;
  },
};

function createBaseIsWhitelistedTopicWorkerRequest(): IsWhitelistedTopicWorkerRequest {
  return { topicId: "0", address: "" };
}

export const IsWhitelistedTopicWorkerRequest: MessageFns<IsWhitelistedTopicWorkerRequest> = {
  encode(message: IsWhitelistedTopicWorkerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedTopicWorkerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedTopicWorkerRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsWhitelistedTopicWorkerRequest {
    return {
  ...
  toJSON(message: IsWhitelistedTopicWorkerRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<IsWhitelistedTopicWorkerRequest>): IsWhitelistedTopicWorkerRequest {
    return IsWhitelistedTopicWorkerRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedTopicWorkerRequest>): IsWhitelistedTopicWorkerRequest {
    const message = createBaseIsWhitelistedTopicWorkerRequest();
    message.topicId = object.topicId ?? "0";
    message.address = object.address ?? "";
    return message;
...
function createBaseIsWhitelistedTopicWorkerResponse(): IsWhitelistedTopicWorkerResponse {
  return { isWhitelistedTopicWorker: false };
}

export const IsWhitelistedTopicWorkerResponse: MessageFns<IsWhitelistedTopicWorkerResponse> = {
  encode(message: IsWhitelistedTopicWorkerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isWhitelistedTopicWorker !== false) {
      writer.uint32(8).bool(message.isWhitelistedTopicWorker);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedTopicWorkerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedTopicWorkerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isWhitelistedTopicWorker = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsWhitelistedTopicWorkerResponse {
    return {
      isWhitelistedTopicWorker: isSet(object.isWhitelistedTopicWorker)
        ? globalThis.Boolean(object.isWhitelistedTopicWorker)
        : false,
    };
  },

  toJSON(message: IsWhitelistedTopicWorkerResponse): unknown {
    const obj: any = {};
    if (message.isWhitelistedTopicWorker !== false) {
      obj.isWhitelistedTopicWorker = message.isWhitelistedTopicWorker;
    }
    return obj;
  },

  create(base?: DeepPartial<IsWhitelistedTopicWorkerResponse>): IsWhitelistedTopicWorkerResponse {
    return IsWhitelistedTopicWorkerResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedTopicWorkerResponse>): IsWhitelistedTopicWorkerResponse {
    const message = createBaseIsWhitelistedTopicWorkerResponse();
    message.isWhitelistedTopicWorker = object.isWhitelistedTopicWorker ?? false;
    return message;
  },
};

function createBaseIsWhitelistedTopicReputerRequest(): IsWhitelistedTopicReputerRequest {
  return { topicId: "0", address: "" };
}

export const IsWhitelistedTopicReputerRequest: MessageFns<IsWhitelistedTopicReputerRequest> = {
  encode(message: IsWhitelistedTopicReputerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedTopicReputerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedTopicReputerRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): IsWhitelistedTopicReputerRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      address: isSet(object.address) ? globalThis.String(object.address) : "",
    };
  ...
  toJSON(message: IsWhitelistedTopicReputerRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<IsWhitelistedTopicReputerRequest>): IsWhitelistedTopicReputerRequest {
    return IsWhitelistedTopicReputerRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedTopicReputerRequest>): IsWhitelistedTopicReputerRequest {
    const message = createBaseIsWhitelistedTopicReputerRequest();
    message.topicId = object.topicId ?? "0";
    message.address = object.address ?? "";
    return message;
...
function createBaseIsWhitelistedTopicReputerResponse(): IsWhitelistedTopicReputerResponse {
  return { isWhitelistedTopicReputer: false };
}

export const IsWhitelistedTopicReputerResponse: MessageFns<IsWhitelistedTopicReputerResponse> = {
  encode(message: IsWhitelistedTopicReputerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isWhitelistedTopicReputer !== false) {
      writer.uint32(8).bool(message.isWhitelistedTopicReputer);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IsWhitelistedTopicReputerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIsWhitelistedTopicReputerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.isWhitelistedTopicReputer = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): IsWhitelistedTopicReputerResponse {
    return {
      isWhitelistedTopicReputer: isSet(object.isWhitelistedTopicReputer)
        ? globalThis.Boolean(object.isWhitelistedTopicReputer)
        : false,
    };
  },

  toJSON(message: IsWhitelistedTopicReputerResponse): unknown {
    const obj: any = {};
    if (message.isWhitelistedTopicReputer !== false) {
      obj.isWhitelistedTopicReputer = message.isWhitelistedTopicReputer;
    }
    return obj;
  },

  create(base?: DeepPartial<IsWhitelistedTopicReputerResponse>): IsWhitelistedTopicReputerResponse {
    return IsWhitelistedTopicReputerResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IsWhitelistedTopicReputerResponse>): IsWhitelistedTopicReputerResponse {
    const message = createBaseIsWhitelistedTopicReputerResponse();
    message.isWhitelistedTopicReputer = object.isWhitelistedTopicReputer ?? false;
    return message;
  },
};

function createBaseCanUpdateAllGlobalWhitelistsRequest(): CanUpdateAllGlobalWhitelistsRequest {
  return { address: "" };
}

export const CanUpdateAllGlobalWhitelistsRequest: MessageFns<CanUpdateAllGlobalWhitelistsRequest> = {
  encode(message: CanUpdateAllGlobalWhitelistsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateAllGlobalWhitelistsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateAllGlobalWhitelistsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanUpdateAllGlobalWhitelistsRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: CanUpdateAllGlobalWhitelistsRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<CanUpdateAllGlobalWhitelistsRequest>): CanUpdateAllGlobalWhitelistsRequest {
    return CanUpdateAllGlobalWhitelistsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateAllGlobalWhitelistsRequest>): CanUpdateAllGlobalWhitelistsRequest {
    const message = createBaseCanUpdateAllGlobalWhitelistsRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseCanUpdateAllGlobalWhitelistsResponse(): CanUpdateAllGlobalWhitelistsResponse {
  return { canUpdateAllGlobalWhitelists: false };
}

export const CanUpdateAllGlobalWhitelistsResponse: MessageFns<CanUpdateAllGlobalWhitelistsResponse> = {
  encode(message: CanUpdateAllGlobalWhitelistsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canUpdateAllGlobalWhitelists !== false) {
      writer.uint32(8).bool(message.canUpdateAllGlobalWhitelists);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateAllGlobalWhitelistsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateAllGlobalWhitelistsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canUpdateAllGlobalWhitelists = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanUpdateAllGlobalWhitelistsResponse {
    return {
      canUpdateAllGlobalWhitelists: isSet(object.canUpdateAllGlobalWhitelists)
        ? globalThis.Boolean(object.canUpdateAllGlobalWhitelists)
        : false,
    };
  },

  toJSON(message: CanUpdateAllGlobalWhitelistsResponse): unknown {
    const obj: any = {};
    if (message.canUpdateAllGlobalWhitelists !== false) {
      obj.canUpdateAllGlobalWhitelists = message.canUpdateAllGlobalWhitelists;
    }
    return obj;
  },

  create(base?: DeepPartial<CanUpdateAllGlobalWhitelistsResponse>): CanUpdateAllGlobalWhitelistsResponse {
    return CanUpdateAllGlobalWhitelistsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateAllGlobalWhitelistsResponse>): CanUpdateAllGlobalWhitelistsResponse {
    const message = createBaseCanUpdateAllGlobalWhitelistsResponse();
    message.canUpdateAllGlobalWhitelists = object.canUpdateAllGlobalWhitelists ?? false;
    return message;
  },
};

function createBaseCanUpdateGlobalWorkerWhitelistRequest(): CanUpdateGlobalWorkerWhitelistRequest {
  return { address: "" };
}

export const CanUpdateGlobalWorkerWhitelistRequest: MessageFns<CanUpdateGlobalWorkerWhitelistRequest> = {
  encode(message: CanUpdateGlobalWorkerWhitelistRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateGlobalWorkerWhitelistRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateGlobalWorkerWhitelistRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanUpdateGlobalWorkerWhitelistRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: CanUpdateGlobalWorkerWhitelistRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<CanUpdateGlobalWorkerWhitelistRequest>): CanUpdateGlobalWorkerWhitelistRequest {
    return CanUpdateGlobalWorkerWhitelistRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateGlobalWorkerWhitelistRequest>): CanUpdateGlobalWorkerWhitelistRequest {
    const message = createBaseCanUpdateGlobalWorkerWhitelistRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseCanUpdateGlobalWorkerWhitelistResponse(): CanUpdateGlobalWorkerWhitelistResponse {
  return { canUpdateGlobalWorkerWhitelist: false };
}

export const CanUpdateGlobalWorkerWhitelistResponse: MessageFns<CanUpdateGlobalWorkerWhitelistResponse> = {
  encode(message: CanUpdateGlobalWorkerWhitelistResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canUpdateGlobalWorkerWhitelist !== false) {
      writer.uint32(8).bool(message.canUpdateGlobalWorkerWhitelist);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateGlobalWorkerWhitelistResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateGlobalWorkerWhitelistResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canUpdateGlobalWorkerWhitelist = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanUpdateGlobalWorkerWhitelistResponse {
    return {
      canUpdateGlobalWorkerWhitelist: isSet(object.canUpdateGlobalWorkerWhitelist)
        ? globalThis.Boolean(object.canUpdateGlobalWorkerWhitelist)
        : false,
    };
  },

  toJSON(message: CanUpdateGlobalWorkerWhitelistResponse): unknown {
    const obj: any = {};
    if (message.canUpdateGlobalWorkerWhitelist !== false) {
      obj.canUpdateGlobalWorkerWhitelist = message.canUpdateGlobalWorkerWhitelist;
    }
    return obj;
  },

  create(base?: DeepPartial<CanUpdateGlobalWorkerWhitelistResponse>): CanUpdateGlobalWorkerWhitelistResponse {
    return CanUpdateGlobalWorkerWhitelistResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateGlobalWorkerWhitelistResponse>): CanUpdateGlobalWorkerWhitelistResponse {
    const message = createBaseCanUpdateGlobalWorkerWhitelistResponse();
    message.canUpdateGlobalWorkerWhitelist = object.canUpdateGlobalWorkerWhitelist ?? false;
    return message;
  },
};

function createBaseCanUpdateGlobalReputerWhitelistRequest(): CanUpdateGlobalReputerWhitelistRequest {
  return { address: "" };
}

export const CanUpdateGlobalReputerWhitelistRequest: MessageFns<CanUpdateGlobalReputerWhitelistRequest> = {
  encode(message: CanUpdateGlobalReputerWhitelistRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateGlobalReputerWhitelistRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateGlobalReputerWhitelistRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanUpdateGlobalReputerWhitelistRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: CanUpdateGlobalReputerWhitelistRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<CanUpdateGlobalReputerWhitelistRequest>): CanUpdateGlobalReputerWhitelistRequest {
    return CanUpdateGlobalReputerWhitelistRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateGlobalReputerWhitelistRequest>): CanUpdateGlobalReputerWhitelistRequest {
    const message = createBaseCanUpdateGlobalReputerWhitelistRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseCanUpdateGlobalReputerWhitelistResponse(): CanUpdateGlobalReputerWhitelistResponse {
  return { canUpdateGlobalReputerWhitelist: false };
}

export const CanUpdateGlobalReputerWhitelistResponse: MessageFns<CanUpdateGlobalReputerWhitelistResponse> = {
  encode(message: CanUpdateGlobalReputerWhitelistResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canUpdateGlobalReputerWhitelist !== false) {
      writer.uint32(8).bool(message.canUpdateGlobalReputerWhitelist);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateGlobalReputerWhitelistResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateGlobalReputerWhitelistResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canUpdateGlobalReputerWhitelist = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanUpdateGlobalReputerWhitelistResponse {
    return {
      canUpdateGlobalReputerWhitelist: isSet(object.canUpdateGlobalReputerWhitelist)
        ? globalThis.Boolean(object.canUpdateGlobalReputerWhitelist)
        : false,
    };
  },

  toJSON(message: CanUpdateGlobalReputerWhitelistResponse): unknown {
    const obj: any = {};
    if (message.canUpdateGlobalReputerWhitelist !== false) {
      obj.canUpdateGlobalReputerWhitelist = message.canUpdateGlobalReputerWhitelist;
    }
    return obj;
  },

  create(base?: DeepPartial<CanUpdateGlobalReputerWhitelistResponse>): CanUpdateGlobalReputerWhitelistResponse {
    return CanUpdateGlobalReputerWhitelistResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateGlobalReputerWhitelistResponse>): CanUpdateGlobalReputerWhitelistResponse {
    const message = createBaseCanUpdateGlobalReputerWhitelistResponse();
    message.canUpdateGlobalReputerWhitelist = object.canUpdateGlobalReputerWhitelist ?? false;
    return message;
  },
};

function createBaseCanUpdateParamsRequest(): CanUpdateParamsRequest {
  return { address: "" };
}

export const CanUpdateParamsRequest: MessageFns<CanUpdateParamsRequest> = {
  encode(message: CanUpdateParamsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateParamsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateParamsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanUpdateParamsRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: CanUpdateParamsRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<CanUpdateParamsRequest>): CanUpdateParamsRequest {
    return CanUpdateParamsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateParamsRequest>): CanUpdateParamsRequest {
    const message = createBaseCanUpdateParamsRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseCanUpdateParamsResponse(): CanUpdateParamsResponse {
  return { canUpdateParams: false };
}

export const CanUpdateParamsResponse: MessageFns<CanUpdateParamsResponse> = {
  encode(message: CanUpdateParamsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canUpdateParams !== false) {
      writer.uint32(8).bool(message.canUpdateParams);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateParamsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canUpdateParams = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanUpdateParamsResponse {
    return { canUpdateParams: isSet(object.canUpdateParams) ? globalThis.Boolean(object.canUpdateParams) : false };
  },

  toJSON(message: CanUpdateParamsResponse): unknown {
    const obj: any = {};
    if (message.canUpdateParams !== false) {
      obj.canUpdateParams = message.canUpdateParams;
    }
    return obj;
  },

  create(base?: DeepPartial<CanUpdateParamsResponse>): CanUpdateParamsResponse {
    return CanUpdateParamsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateParamsResponse>): CanUpdateParamsResponse {
    const message = createBaseCanUpdateParamsResponse();
    message.canUpdateParams = object.canUpdateParams ?? false;
    return message;
  },
};

function createBaseCanUpdateTopicWhitelistRequest(): CanUpdateTopicWhitelistRequest {
  return { topicId: "0", address: "" };
}

export const CanUpdateTopicWhitelistRequest: MessageFns<CanUpdateTopicWhitelistRequest> = {
  encode(message: CanUpdateTopicWhitelistRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateTopicWhitelistRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateTopicWhitelistRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanUpdateTopicWhitelistRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      address: isSet(object.address) ? globalThis.String(object.address) : "",
    };
  ...
  toJSON(message: CanUpdateTopicWhitelistRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<CanUpdateTopicWhitelistRequest>): CanUpdateTopicWhitelistRequest {
    return CanUpdateTopicWhitelistRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateTopicWhitelistRequest>): CanUpdateTopicWhitelistRequest {
    const message = createBaseCanUpdateTopicWhitelistRequest();
    message.topicId = object.topicId ?? "0";
    message.address = object.address ?? "";
    return message;
...
function createBaseCanUpdateTopicWhitelistResponse(): CanUpdateTopicWhitelistResponse {
  return { canUpdateTopicWhitelist: false };
}

export const CanUpdateTopicWhitelistResponse: MessageFns<CanUpdateTopicWhitelistResponse> = {
  encode(message: CanUpdateTopicWhitelistResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canUpdateTopicWhitelist !== false) {
      writer.uint32(8).bool(message.canUpdateTopicWhitelist);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateTopicWhitelistResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateTopicWhitelistResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canUpdateTopicWhitelist = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanUpdateTopicWhitelistResponse {
    return {
      canUpdateTopicWhitelist: isSet(object.canUpdateTopicWhitelist)
        ? globalThis.Boolean(object.canUpdateTopicWhitelist)
        : false,
    };
  },

  toJSON(message: CanUpdateTopicWhitelistResponse): unknown {
    const obj: any = {};
    if (message.canUpdateTopicWhitelist !== false) {
      obj.canUpdateTopicWhitelist = message.canUpdateTopicWhitelist;
    }
    return obj;
  },

  create(base?: DeepPartial<CanUpdateTopicWhitelistResponse>): CanUpdateTopicWhitelistResponse {
    return CanUpdateTopicWhitelistResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateTopicWhitelistResponse>): CanUpdateTopicWhitelistResponse {
    const message = createBaseCanUpdateTopicWhitelistResponse();
    message.canUpdateTopicWhitelist = object.canUpdateTopicWhitelist ?? false;
    return message;
  },
};

function createBaseCanCreateTopicRequest(): CanCreateTopicRequest {
  return { address: "" };
}

export const CanCreateTopicRequest: MessageFns<CanCreateTopicRequest> = {
  encode(message: CanCreateTopicRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanCreateTopicRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanCreateTopicRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanCreateTopicRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: CanCreateTopicRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<CanCreateTopicRequest>): CanCreateTopicRequest {
    return CanCreateTopicRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanCreateTopicRequest>): CanCreateTopicRequest {
    const message = createBaseCanCreateTopicRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseCanCreateTopicResponse(): CanCreateTopicResponse {
  return { canCreateTopic: false };
}

export const CanCreateTopicResponse: MessageFns<CanCreateTopicResponse> = {
  encode(message: CanCreateTopicResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canCreateTopic !== false) {
      writer.uint32(8).bool(message.canCreateTopic);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanCreateTopicResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanCreateTopicResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canCreateTopic = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanCreateTopicResponse {
    return { canCreateTopic: isSet(object.canCreateTopic) ? globalThis.Boolean(object.canCreateTopic) : false };
  },

  toJSON(message: CanCreateTopicResponse): unknown {
    const obj: any = {};
    if (message.canCreateTopic !== false) {
      obj.canCreateTopic = message.canCreateTopic;
    }
    return obj;
  },

  create(base?: DeepPartial<CanCreateTopicResponse>): CanCreateTopicResponse {
    return CanCreateTopicResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanCreateTopicResponse>): CanCreateTopicResponse {
    const message = createBaseCanCreateTopicResponse();
    message.canCreateTopic = object.canCreateTopic ?? false;
    return message;
  },
};

function createBaseCanSubmitWorkerPayloadRequest(): CanSubmitWorkerPayloadRequest {
  return { topicId: "0", address: "" };
}

export const CanSubmitWorkerPayloadRequest: MessageFns<CanSubmitWorkerPayloadRequest> = {
  encode(message: CanSubmitWorkerPayloadRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanSubmitWorkerPayloadRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanSubmitWorkerPayloadRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanSubmitWorkerPayloadRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      address: isSet(object.address) ? globalThis.String(object.address) : "",
    };
  ...
  toJSON(message: CanSubmitWorkerPayloadRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<CanSubmitWorkerPayloadRequest>): CanSubmitWorkerPayloadRequest {
    return CanSubmitWorkerPayloadRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanSubmitWorkerPayloadRequest>): CanSubmitWorkerPayloadRequest {
    const message = createBaseCanSubmitWorkerPayloadRequest();
    message.topicId = object.topicId ?? "0";
    message.address = object.address ?? "";
    return message;
...
function createBaseCanSubmitWorkerPayloadResponse(): CanSubmitWorkerPayloadResponse {
  return { canSubmitWorkerPayload: false };
}

export const CanSubmitWorkerPayloadResponse: MessageFns<CanSubmitWorkerPayloadResponse> = {
  encode(message: CanSubmitWorkerPayloadResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canSubmitWorkerPayload !== false) {
      writer.uint32(8).bool(message.canSubmitWorkerPayload);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanSubmitWorkerPayloadResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanSubmitWorkerPayloadResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canSubmitWorkerPayload = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanSubmitWorkerPayloadResponse {
    return {
      canSubmitWorkerPayload: isSet(object.canSubmitWorkerPayload)
        ? globalThis.Boolean(object.canSubmitWorkerPayload)
        : false,
    };
  },

  toJSON(message: CanSubmitWorkerPayloadResponse): unknown {
    const obj: any = {};
    if (message.canSubmitWorkerPayload !== false) {
      obj.canSubmitWorkerPayload = message.canSubmitWorkerPayload;
    }
    return obj;
  },

  create(base?: DeepPartial<CanSubmitWorkerPayloadResponse>): CanSubmitWorkerPayloadResponse {
    return CanSubmitWorkerPayloadResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanSubmitWorkerPayloadResponse>): CanSubmitWorkerPayloadResponse {
    const message = createBaseCanSubmitWorkerPayloadResponse();
    message.canSubmitWorkerPayload = object.canSubmitWorkerPayload ?? false;
    return message;
  },
};

function createBaseCanSubmitReputerPayloadRequest(): CanSubmitReputerPayloadRequest {
  return { topicId: "0", address: "" };
}

export const CanSubmitReputerPayloadRequest: MessageFns<CanSubmitReputerPayloadRequest> = {
  encode(message: CanSubmitReputerPayloadRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanSubmitReputerPayloadRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanSubmitReputerPayloadRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanSubmitReputerPayloadRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      address: isSet(object.address) ? globalThis.String(object.address) : "",
    };
  ...
  toJSON(message: CanSubmitReputerPayloadRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<CanSubmitReputerPayloadRequest>): CanSubmitReputerPayloadRequest {
    return CanSubmitReputerPayloadRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanSubmitReputerPayloadRequest>): CanSubmitReputerPayloadRequest {
    const message = createBaseCanSubmitReputerPayloadRequest();
    message.topicId = object.topicId ?? "0";
    message.address = object.address ?? "";
    return message;
...
function createBaseCanSubmitReputerPayloadResponse(): CanSubmitReputerPayloadResponse {
  return { canSubmitReputerPayload: false };
}

export const CanSubmitReputerPayloadResponse: MessageFns<CanSubmitReputerPayloadResponse> = {
  encode(message: CanSubmitReputerPayloadResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canSubmitReputerPayload !== false) {
      writer.uint32(8).bool(message.canSubmitReputerPayload);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanSubmitReputerPayloadResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanSubmitReputerPayloadResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canSubmitReputerPayload = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanSubmitReputerPayloadResponse {
    return {
      canSubmitReputerPayload: isSet(object.canSubmitReputerPayload)
        ? globalThis.Boolean(object.canSubmitReputerPayload)
        : false,
    };
  },

  toJSON(message: CanSubmitReputerPayloadResponse): unknown {
    const obj: any = {};
    if (message.canSubmitReputerPayload !== false) {
      obj.canSubmitReputerPayload = message.canSubmitReputerPayload;
    }
    return obj;
  },

  create(base?: DeepPartial<CanSubmitReputerPayloadResponse>): CanSubmitReputerPayloadResponse {
    return CanSubmitReputerPayloadResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanSubmitReputerPayloadResponse>): CanSubmitReputerPayloadResponse {
    const message = createBaseCanSubmitReputerPayloadResponse();
    message.canSubmitReputerPayload = object.canSubmitReputerPayload ?? false;
    return message;
  },
};
...
function createBaseGetNetworkInferencesAtBlockOutlierResistantRequest(): GetNetworkInferencesAtBlockOutlierResistantRequest {
  return { topicId: "0", blockHeightLastInference: "0" };
}

export const GetNetworkInferencesAtBlockOutlierResistantRequest: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetNetworkInferencesAtBlockOutlierResistantRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetNetworkInferencesAtBlockOutlierResistantRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetNetworkInferencesAtBlockOutlierResistantRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      blockHeightLastInference: isSet(object.blockHeightLastInference)
        ? globalThis.String(object.blockHeightLastInference)
  ...
  toJSON(message: GetNetworkInferencesAtBlockOutlierResistantRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(
    base?: DeepPartial<GetNetworkInferencesAtBlockOutlierResistantRequest>,
  ): GetNetworkInferencesAtBlockOutlierResistantRequest {
    return GetNetworkInferencesAtBlockOutlierResistantRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetNetworkInferencesAtBlockOutlierResistantRequest>,
  ): GetNetworkInferencesAtBlockOutlierResistantRequest {
    const message = createBaseGetNetworkInferencesAtBlockOutlierResistantRequest();
    message.topicId = object.topicId ?? "0";
    message.blockHeightLastInference = object.blockHeightLastInference ?? "0";
...
function createBaseGetLatestNetworkInferencesOutlierResistantRequest(): GetLatestNetworkInferencesOutlierResistantRequest {
  return { topicId: "0" };
}

export const GetLatestNetworkInferencesOutlierResistantRequest: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLatestNetworkInferencesOutlierResistantRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetLatestNetworkInferencesOutlierResistantRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetLatestNetworkInferencesOutlierResistantRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: GetLatestNetworkInferencesOutlierResistantRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(
    base?: DeepPartial<GetLatestNetworkInferencesOutlierResistantRequest>,
  ): GetLatestNetworkInferencesOutlierResistantRequest {
    return GetLatestNetworkInferencesOutlierResistantRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetLatestNetworkInferencesOutlierResistantRequest>,
  ): GetLatestNetworkInferencesOutlierResistantRequest {
    const message = createBaseGetLatestNetworkInferencesOutlierResistantRequest();
    message.topicId = object.topicId ?? "0";
    return message;
...
function createBaseGetLatestAvailableNetworkInferencesOutlierResistantRequest(): GetLatestAvailableNetworkInferencesOutlierResistantRequest {
  return { topicId: "0" };
}

export const GetLatestAvailableNetworkInferencesOutlierResistantRequest: MessageFns<
...
> = {
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetLatestAvailableNetworkInferencesOutlierResistantRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetLatestAvailableNetworkInferencesOutlierResistantRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: GetLatestAvailableNetworkInferencesOutlierResistantRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(
    base?: DeepPartial<GetLatestAvailableNetworkInferencesOutlierResistantRequest>,
  ): GetLatestAvailableNetworkInferencesOutlierResistantRequest {
    return GetLatestAvailableNetworkInferencesOutlierResistantRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetLatestAvailableNetworkInferencesOutlierResistantRequest>,
  ): GetLatestAvailableNetworkInferencesOutlierResistantRequest {
    const message = createBaseGetLatestAvailableNetworkInferencesOutlierResistantRequest();
    message.topicId = object.topicId ?? "0";
    return message;
...
function createBaseGetNetworkInferencesAtBlockOutlierResistantResponse(): GetNetworkInferencesAtBlockOutlierResistantResponse {
  return { networkInferences: undefined };
}

export const GetNetworkInferencesAtBlockOutlierResistantResponse: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetNetworkInferencesAtBlockOutlierResistantResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetNetworkInferencesAtBlockOutlierResistantResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetNetworkInferencesAtBlockOutlierResistantResponse {
    return {
      networkInferences: isSet(object.networkInferences) ? ValueBundle.fromJSON(object.networkInferences) : undefined,
    };
  },

  toJSON(message: GetNetworkInferencesAtBlockOutlierResistantResponse): unknown {
    const obj: any = {};
    if (message.networkInferences !== undefined) {
      obj.networkInferences = ValueBundle.toJSON(message.networkInferences);
    }
  ...
  create(
    base?: DeepPartial<GetNetworkInferencesAtBlockOutlierResistantResponse>,
  ): GetNetworkInferencesAtBlockOutlierResistantResponse {
    return GetNetworkInferencesAtBlockOutlierResistantResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetNetworkInferencesAtBlockOutlierResistantResponse>,
  ): GetNetworkInferencesAtBlockOutlierResistantResponse {
    const message = createBaseGetNetworkInferencesAtBlockOutlierResistantResponse();
    message.networkInferences = (object.networkInferences !== undefined && object.networkInferences !== null)
      ? ValueBundle.fromPartial(object.networkInferences)
...
function createBaseGetLatestNetworkInferencesOutlierResistantResponse(): GetLatestNetworkInferencesOutlierResistantResponse {
  return {
    networkInferences: undefined,
    infererWeights: [],
    forecasterWeights: [],
...
export const GetLatestNetworkInferencesOutlierResistantResponse: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLatestNetworkInferencesOutlierResistantResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetLatestNetworkInferencesOutlierResistantResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetLatestNetworkInferencesOutlierResistantResponse {
    return {
      networkInferences: isSet(object.networkInferences) ? ValueBundle.fromJSON(object.networkInferences) : undefined,
      infererWeights: globalThis.Array.isArray(object?.infererWeights)
        ? object.infererWeights.map((e: any) => RegretInformedWeight.fromJSON(e))
  ...
  toJSON(message: GetLatestNetworkInferencesOutlierResistantResponse): unknown {
    const obj: any = {};
    if (message.networkInferences !== undefined) {
      obj.networkInferences = ValueBundle.toJSON(message.networkInferences);
    }
  ...
  create(
    base?: DeepPartial<GetLatestNetworkInferencesOutlierResistantResponse>,
  ): GetLatestNetworkInferencesOutlierResistantResponse {
    return GetLatestNetworkInferencesOutlierResistantResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetLatestNetworkInferencesOutlierResistantResponse>,
  ): GetLatestNetworkInferencesOutlierResistantResponse {
    const message = createBaseGetLatestNetworkInferencesOutlierResistantResponse();
    message.networkInferences = (object.networkInferences !== undefined && object.networkInferences !== null)
      ? ValueBundle.fromPartial(object.networkInferences)
...
function createBaseGetLatestAvailableNetworkInferencesOutlierResistantResponse(): GetLatestAvailableNetworkInferencesOutlierResistantResponse {
  return {
    networkInferences: undefined,
    infererWeights: [],
    forecasterWeights: [],
...
export const GetLatestAvailableNetworkInferencesOutlierResistantResponse: MessageFns<
...
> = {
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetLatestAvailableNetworkInferencesOutlierResistantResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetLatestAvailableNetworkInferencesOutlierResistantResponse {
    return {
      networkInferences: isSet(object.networkInferences) ? ValueBundle.fromJSON(object.networkInferences) : undefined,
      infererWeights: globalThis.Array.isArray(object?.infererWeights)
        ? object.infererWeights.map((e: any) => RegretInformedWeight.fromJSON(e))
  ...
  toJSON(message: GetLatestAvailableNetworkInferencesOutlierResistantResponse): unknown {
    const obj: any = {};
    if (message.networkInferences !== undefined) {
      obj.networkInferences = ValueBundle.toJSON(message.networkInferences);
    }
  ...
  create(
    base?: DeepPartial<GetLatestAvailableNetworkInferencesOutlierResistantResponse>,
  ): GetLatestAvailableNetworkInferencesOutlierResistantResponse {
    return GetLatestAvailableNetworkInferencesOutlierResistantResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetLatestAvailableNetworkInferencesOutlierResistantResponse>,
  ): GetLatestAvailableNetworkInferencesOutlierResistantResponse {
    const message = createBaseGetLatestAvailableNetworkInferencesOutlierResistantResponse();
    message.networkInferences = (object.networkInferences !== undefined && object.networkInferences !== null)
      ? ValueBundle.fromPartial(object.networkInferences)
...
function createBaseGetTopicInitialInfererEmaScoreRequest(): GetTopicInitialInfererEmaScoreRequest {
  return { topicId: "0" };
}

export const GetTopicInitialInfererEmaScoreRequest: MessageFns<GetTopicInitialInfererEmaScoreRequest> = {
  encode(message: GetTopicInitialInfererEmaScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTopicInitialInfererEmaScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTopicInitialInfererEmaScoreRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTopicInitialInfererEmaScoreRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: GetTopicInitialInfererEmaScoreRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<GetTopicInitialInfererEmaScoreRequest>): GetTopicInitialInfererEmaScoreRequest {
    return GetTopicInitialInfererEmaScoreRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetTopicInitialInfererEmaScoreRequest>): GetTopicInitialInfererEmaScoreRequest {
    const message = createBaseGetTopicInitialInfererEmaScoreRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseGetTopicInitialInfererEmaScoreResponse(): GetTopicInitialInfererEmaScoreResponse {
  return { score: "" };
}

export const GetTopicInitialInfererEmaScoreResponse: MessageFns<GetTopicInitialInfererEmaScoreResponse> = {
  encode(message: GetTopicInitialInfererEmaScoreResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTopicInitialInfererEmaScoreResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTopicInitialInfererEmaScoreResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTopicInitialInfererEmaScoreResponse {
    return { score: isSet(object.score) ? globalThis.String(object.score) : "" };
  },

  toJSON(message: GetTopicInitialInfererEmaScoreResponse): unknown {
    const obj: any = {};
    if (message.score !== "") {
  ...
  create(base?: DeepPartial<GetTopicInitialInfererEmaScoreResponse>): GetTopicInitialInfererEmaScoreResponse {
    return GetTopicInitialInfererEmaScoreResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetTopicInitialInfererEmaScoreResponse>): GetTopicInitialInfererEmaScoreResponse {
    const message = createBaseGetTopicInitialInfererEmaScoreResponse();
...
function createBaseGetTopicInitialForecasterEmaScoreRequest(): GetTopicInitialForecasterEmaScoreRequest {
  return { topicId: "0" };
}

export const GetTopicInitialForecasterEmaScoreRequest: MessageFns<GetTopicInitialForecasterEmaScoreRequest> = {
  encode(message: GetTopicInitialForecasterEmaScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTopicInitialForecasterEmaScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTopicInitialForecasterEmaScoreRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTopicInitialForecasterEmaScoreRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: GetTopicInitialForecasterEmaScoreRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<GetTopicInitialForecasterEmaScoreRequest>): GetTopicInitialForecasterEmaScoreRequest {
    return GetTopicInitialForecasterEmaScoreRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetTopicInitialForecasterEmaScoreRequest>): GetTopicInitialForecasterEmaScoreRequest {
    const message = createBaseGetTopicInitialForecasterEmaScoreRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseGetTopicInitialForecasterEmaScoreResponse(): GetTopicInitialForecasterEmaScoreResponse {
  return { score: "" };
}

export const GetTopicInitialForecasterEmaScoreResponse: MessageFns<GetTopicInitialForecasterEmaScoreResponse> = {
  encode(message: GetTopicInitialForecasterEmaScoreResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== "") {
      writer.uint32(10).string(message.score);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTopicInitialForecasterEmaScoreResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTopicInitialForecasterEmaScoreResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTopicInitialForecasterEmaScoreResponse {
    return { score: isSet(object.score) ? globalThis.String(object.score) : "" };
  },

  toJSON(message: GetTopicInitialForecasterEmaScoreResponse): unknown {
    const obj: any = {};
    if (message.score !== "") {
      obj.score = message.score;
    }
  ...
  create(base?: DeepPartial<GetTopicInitialForecasterEmaScoreResponse>): GetTopicInitialForecasterEmaScoreResponse {
    return GetTopicInitialForecasterEmaScoreResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetTopicInitialForecasterEmaScoreResponse>,
...
function createBaseGetTopicInitialReputerEmaScoreRequest(): GetTopicInitialReputerEmaScoreRequest {
  return { topicId: "0" };
}

export const GetTopicInitialReputerEmaScoreRequest: MessageFns<GetTopicInitialReputerEmaScoreRequest> = {
  encode(message: GetTopicInitialReputerEmaScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTopicInitialReputerEmaScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTopicInitialReputerEmaScoreRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTopicInitialReputerEmaScoreRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: GetTopicInitialReputerEmaScoreRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<GetTopicInitialReputerEmaScoreRequest>): GetTopicInitialReputerEmaScoreRequest {
    return GetTopicInitialReputerEmaScoreRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetTopicInitialReputerEmaScoreRequest>): GetTopicInitialReputerEmaScoreRequest {
    const message = createBaseGetTopicInitialReputerEmaScoreRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseGetTopicInitialReputerEmaScoreResponse(): GetTopicInitialReputerEmaScoreResponse {
  return { score: "" };
}

export const GetTopicInitialReputerEmaScoreResponse: MessageFns<GetTopicInitialReputerEmaScoreResponse> = {
  encode(message: GetTopicInitialReputerEmaScoreResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== "") {
      writer.uint32(10).string(message.score);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTopicInitialReputerEmaScoreResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetTopicInitialReputerEmaScoreResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetTopicInitialReputerEmaScoreResponse {
    return { score: isSet(object.score) ? globalThis.String(object.score) : "" };
  },

  toJSON(message: GetTopicInitialReputerEmaScoreResponse): unknown {
    const obj: any = {};
    if (message.score !== "") {
      obj.score = message.score;
    }
  ...
  create(base?: DeepPartial<GetTopicInitialReputerEmaScoreResponse>): GetTopicInitialReputerEmaScoreResponse {
    return GetTopicInitialReputerEmaScoreResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetTopicInitialReputerEmaScoreResponse>): GetTopicInitialReputerEmaScoreResponse {
    const message = createBaseGetTopicInitialReputerEmaScoreResponse();
    message.score = object.score ?? "";
    return message;
  },
...
export interface QueryService {
  ...
  GetNetworkInferencesAtBlockOutlierResistant(
    request: GetNetworkInferencesAtBlockOutlierResistantRequest,
  ...
  GetLatestNetworkInferencesOutlierResistant(
    request: GetLatestNetworkInferencesOutlierResistantRequest,
  ...
  GetLatestAvailableNetworkInferencesOutlierResistant(
    request: GetLatestAvailableNetworkInferencesOutlierResistantRequest,
  ...
  IsWhitelistedGlobalWorker(request: IsWhitelistedGlobalWorkerRequest): Promise<IsWhitelistedGlobalWorkerResponse>;
  IsWhitelistedGlobalReputer(request: IsWhitelistedGlobalReputerRequest): Promise<IsWhitelistedGlobalReputerResponse>;
  IsWhitelistedGlobalAdmin(request: IsWhitelistedGlobalAdminRequest): Promise<IsWhitelistedGlobalAdminResponse>;
  IsTopicWorkerWhitelistEnabled(
    request: IsTopicWorkerWhitelistEnabledRequest,
  ): Promise<IsTopicWorkerWhitelistEnabledResponse>;
  IsTopicReputerWhitelistEnabled(
    request: IsTopicReputerWhitelistEnabledRequest,
  ): Promise<IsTopicReputerWhitelistEnabledResponse>;
  IsWhitelistedTopicCreator(request: IsWhitelistedTopicCreatorRequest): Promise<IsWhitelistedTopicCreatorResponse>;
  IsWhitelistedGlobalActor(request: IsWhitelistedGlobalActorRequest): Promise<IsWhitelistedGlobalActorResponse>;
  IsWhitelistedTopicWorker(request: IsWhitelistedTopicWorkerRequest): Promise<IsWhitelistedTopicWorkerResponse>;
  IsWhitelistedTopicReputer(request: IsWhitelistedTopicReputerRequest): Promise<IsWhitelistedTopicReputerResponse>;
  CanUpdateAllGlobalWhitelists(
    request: CanUpdateAllGlobalWhitelistsRequest,
  ): Promise<CanUpdateAllGlobalWhitelistsResponse>;
  CanUpdateGlobalWorkerWhitelist(
    request: CanUpdateGlobalWorkerWhitelistRequest,
  ): Promise<CanUpdateGlobalWorkerWhitelistResponse>;
  CanUpdateGlobalReputerWhitelist(
    request: CanUpdateGlobalReputerWhitelistRequest,
  ): Promise<CanUpdateGlobalReputerWhitelistResponse>;
  CanUpdateParams(request: CanUpdateParamsRequest): Promise<CanUpdateParamsResponse>;
  CanUpdateTopicWhitelist(request: CanUpdateTopicWhitelistRequest): Promise<CanUpdateTopicWhitelistResponse>;
  CanCreateTopic(request: CanCreateTopicRequest): Promise<CanCreateTopicResponse>;
  CanSubmitWorkerPayload(request: CanSubmitWorkerPayloadRequest): Promise<CanSubmitWorkerPayloadResponse>;
  CanSubmitReputerPayload(request: CanSubmitReputerPayloadRequest): Promise<CanSubmitReputerPayloadResponse>;
  /** GetTopicInitialInfererEmaScore returns the initial EMA score for inferers in a topic */
  GetTopicInitialInfererEmaScore(
    request: GetTopicInitialInfererEmaScoreRequest,
  ...
  GetTopicInitialForecasterEmaScore(
    request: GetTopicInitialForecasterEmaScoreRequest,
  ...
  GetTopicInitialReputerEmaScore(
    request: GetTopicInitialReputerEmaScoreRequest,
  ): Promise<GetTopicInitialReputerEmaScoreResponse>;
}

export const QueryServiceServiceName = "emissions.v7.QueryService";
export class QueryServiceClientImpl implements QueryService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.GetNetworkInferencesAtBlockOutlierResistant = this.GetNetworkInferencesAtBlockOutlierResistant.bind(this);
    this.GetLatestNetworkInferences = this.GetLatestNetworkInferences.bind(this);
    this.GetLatestNetworkInferencesOutlierResistant = this.GetLatestNetworkInferencesOutlierResistant.bind(this);
    this.GetLatestAvailableNetworkInferences = this.GetLatestAvailableNetworkInferences.bind(this);
    this.GetLatestAvailableNetworkInferencesOutlierResistant = this.GetLatestAvailableNetworkInferencesOutlierResistant
      .bind(this);
    ...
    this.IsWhitelistedGlobalWorker = this.IsWhitelistedGlobalWorker.bind(this);
    this.IsWhitelistedGlobalReputer = this.IsWhitelistedGlobalReputer.bind(this);
    this.IsWhitelistedGlobalAdmin = this.IsWhitelistedGlobalAdmin.bind(this);
    this.IsTopicWorkerWhitelistEnabled = this.IsTopicWorkerWhitelistEnabled.bind(this);
    this.IsTopicReputerWhitelistEnabled = this.IsTopicReputerWhitelistEnabled.bind(this);
    this.IsWhitelistedTopicCreator = this.IsWhitelistedTopicCreator.bind(this);
    this.IsWhitelistedGlobalActor = this.IsWhitelistedGlobalActor.bind(this);
    this.IsWhitelistedTopicWorker = this.IsWhitelistedTopicWorker.bind(this);
    this.IsWhitelistedTopicReputer = this.IsWhitelistedTopicReputer.bind(this);
    this.CanUpdateAllGlobalWhitelists = this.CanUpdateAllGlobalWhitelists.bind(this);
    this.CanUpdateGlobalWorkerWhitelist = this.CanUpdateGlobalWorkerWhitelist.bind(this);
    this.CanUpdateGlobalReputerWhitelist = this.CanUpdateGlobalReputerWhitelist.bind(this);
    this.CanUpdateParams = this.CanUpdateParams.bind(this);
    this.CanUpdateTopicWhitelist = this.CanUpdateTopicWhitelist.bind(this);
    this.CanCreateTopic = this.CanCreateTopic.bind(this);
    this.CanSubmitWorkerPayload = this.CanSubmitWorkerPayload.bind(this);
    this.CanSubmitReputerPayload = this.CanSubmitReputerPayload.bind(this);
    this.GetTopicInitialInfererEmaScore = this.GetTopicInitialInfererEmaScore.bind(this);
    this.GetTopicInitialForecasterEmaScore = this.GetTopicInitialForecasterEmaScore.bind(this);
    this.GetTopicInitialReputerEmaScore = this.GetTopicInitialReputerEmaScore.bind(this);
  }
  GetParams(request: GetParamsRequest): Promise<GetParamsResponse> {
  ...
  GetNetworkInferencesAtBlockOutlierResistant(
    ...
    const data = GetNetworkInferencesAtBlockOutlierResistantRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetNetworkInferencesAtBlockOutlierResistant", data);
    return promise.then((data) => GetNetworkInferencesAtBlockOutlierResistantResponse.decode(new BinaryReader(data)));
  }
  ...
  GetLatestNetworkInferencesOutlierResistant(
    ...
    const data = GetLatestNetworkInferencesOutlierResistantRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetLatestNetworkInferencesOutlierResistant", data);
    return promise.then((data) => GetLatestNetworkInferencesOutlierResistantResponse.decode(new BinaryReader(data)));
  }
  ...
  GetLatestAvailableNetworkInferencesOutlierResistant(
    ...
    const data = GetLatestAvailableNetworkInferencesOutlierResistantRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetLatestAvailableNetworkInferencesOutlierResistant", data);
    return promise.then((data) =>
      GetLatestAvailableNetworkInferencesOutlierResistantResponse.decode(new BinaryReader(data))
    );
  }
  ...
  IsWhitelistedGlobalWorker(request: IsWhitelistedGlobalWorkerRequest): Promise<IsWhitelistedGlobalWorkerResponse> {
    const data = IsWhitelistedGlobalWorkerRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsWhitelistedGlobalWorker", data);
    return promise.then((data) => IsWhitelistedGlobalWorkerResponse.decode(new BinaryReader(data)));
  }

  IsWhitelistedGlobalReputer(request: IsWhitelistedGlobalReputerRequest): Promise<IsWhitelistedGlobalReputerResponse> {
    const data = IsWhitelistedGlobalReputerRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsWhitelistedGlobalReputer", data);
    return promise.then((data) => IsWhitelistedGlobalReputerResponse.decode(new BinaryReader(data)));
  }

  IsWhitelistedGlobalAdmin(request: IsWhitelistedGlobalAdminRequest): Promise<IsWhitelistedGlobalAdminResponse> {
    const data = IsWhitelistedGlobalAdminRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsWhitelistedGlobalAdmin", data);
    return promise.then((data) => IsWhitelistedGlobalAdminResponse.decode(new BinaryReader(data)));
  }

  IsTopicWorkerWhitelistEnabled(
    request: IsTopicWorkerWhitelistEnabledRequest,
  ): Promise<IsTopicWorkerWhitelistEnabledResponse> {
    const data = IsTopicWorkerWhitelistEnabledRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsTopicWorkerWhitelistEnabled", data);
    return promise.then((data) => IsTopicWorkerWhitelistEnabledResponse.decode(new BinaryReader(data)));
  }

  IsTopicReputerWhitelistEnabled(
    request: IsTopicReputerWhitelistEnabledRequest,
  ): Promise<IsTopicReputerWhitelistEnabledResponse> {
    const data = IsTopicReputerWhitelistEnabledRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsTopicReputerWhitelistEnabled", data);
    return promise.then((data) => IsTopicReputerWhitelistEnabledResponse.decode(new BinaryReader(data)));
  }

  IsWhitelistedTopicCreator(request: IsWhitelistedTopicCreatorRequest): Promise<IsWhitelistedTopicCreatorResponse> {
    const data = IsWhitelistedTopicCreatorRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsWhitelistedTopicCreator", data);
    return promise.then((data) => IsWhitelistedTopicCreatorResponse.decode(new BinaryReader(data)));
  }

  IsWhitelistedGlobalActor(request: IsWhitelistedGlobalActorRequest): Promise<IsWhitelistedGlobalActorResponse> {
    const data = IsWhitelistedGlobalActorRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsWhitelistedGlobalActor", data);
    return promise.then((data) => IsWhitelistedGlobalActorResponse.decode(new BinaryReader(data)));
  }

  IsWhitelistedTopicWorker(request: IsWhitelistedTopicWorkerRequest): Promise<IsWhitelistedTopicWorkerResponse> {
    const data = IsWhitelistedTopicWorkerRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsWhitelistedTopicWorker", data);
    return promise.then((data) => IsWhitelistedTopicWorkerResponse.decode(new BinaryReader(data)));
  }

  IsWhitelistedTopicReputer(request: IsWhitelistedTopicReputerRequest): Promise<IsWhitelistedTopicReputerResponse> {
    const data = IsWhitelistedTopicReputerRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "IsWhitelistedTopicReputer", data);
    return promise.then((data) => IsWhitelistedTopicReputerResponse.decode(new BinaryReader(data)));
  }

  CanUpdateAllGlobalWhitelists(
    request: CanUpdateAllGlobalWhitelistsRequest,
  ): Promise<CanUpdateAllGlobalWhitelistsResponse> {
    const data = CanUpdateAllGlobalWhitelistsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanUpdateAllGlobalWhitelists", data);
    return promise.then((data) => CanUpdateAllGlobalWhitelistsResponse.decode(new BinaryReader(data)));
  }

  CanUpdateGlobalWorkerWhitelist(
    request: CanUpdateGlobalWorkerWhitelistRequest,
  ): Promise<CanUpdateGlobalWorkerWhitelistResponse> {
    const data = CanUpdateGlobalWorkerWhitelistRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanUpdateGlobalWorkerWhitelist", data);
    return promise.then((data) => CanUpdateGlobalWorkerWhitelistResponse.decode(new BinaryReader(data)));
  }

  CanUpdateGlobalReputerWhitelist(
    request: CanUpdateGlobalReputerWhitelistRequest,
  ): Promise<CanUpdateGlobalReputerWhitelistResponse> {
    const data = CanUpdateGlobalReputerWhitelistRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanUpdateGlobalReputerWhitelist", data);
    return promise.then((data) => CanUpdateGlobalReputerWhitelistResponse.decode(new BinaryReader(data)));
  }

  CanUpdateParams(request: CanUpdateParamsRequest): Promise<CanUpdateParamsResponse> {
    const data = CanUpdateParamsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanUpdateParams", data);
    return promise.then((data) => CanUpdateParamsResponse.decode(new BinaryReader(data)));
  }

  CanUpdateTopicWhitelist(request: CanUpdateTopicWhitelistRequest): Promise<CanUpdateTopicWhitelistResponse> {
    const data = CanUpdateTopicWhitelistRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanUpdateTopicWhitelist", data);
    return promise.then((data) => CanUpdateTopicWhitelistResponse.decode(new BinaryReader(data)));
  }

  CanCreateTopic(request: CanCreateTopicRequest): Promise<CanCreateTopicResponse> {
    const data = CanCreateTopicRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanCreateTopic", data);
    return promise.then((data) => CanCreateTopicResponse.decode(new BinaryReader(data)));
  }

  CanSubmitWorkerPayload(request: CanSubmitWorkerPayloadRequest): Promise<CanSubmitWorkerPayloadResponse> {
    const data = CanSubmitWorkerPayloadRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanSubmitWorkerPayload", data);
    return promise.then((data) => CanSubmitWorkerPayloadResponse.decode(new BinaryReader(data)));
  }

  CanSubmitReputerPayload(request: CanSubmitReputerPayloadRequest): Promise<CanSubmitReputerPayloadResponse> {
    const data = CanSubmitReputerPayloadRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanSubmitReputerPayload", data);
    return promise.then((data) => CanSubmitReputerPayloadResponse.decode(new BinaryReader(data)));
  }

  GetTopicInitialInfererEmaScore(
    request: GetTopicInitialInfererEmaScoreRequest,
  ): Promise<GetTopicInitialInfererEmaScoreResponse> {
    const data = GetTopicInitialInfererEmaScoreRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTopicInitialInfererEmaScore", data);
    return promise.then((data) => GetTopicInitialInfererEmaScoreResponse.decode(new BinaryReader(data)));
  }

  GetTopicInitialForecasterEmaScore(
    request: GetTopicInitialForecasterEmaScoreRequest,
  ): Promise<GetTopicInitialForecasterEmaScoreResponse> {
    const data = GetTopicInitialForecasterEmaScoreRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTopicInitialForecasterEmaScore", data);
    return promise.then((data) => GetTopicInitialForecasterEmaScoreResponse.decode(new BinaryReader(data)));
  }

  GetTopicInitialReputerEmaScore(
    request: GetTopicInitialReputerEmaScoreRequest,
  ): Promise<GetTopicInitialReputerEmaScoreResponse> {
    const data = GetTopicInitialReputerEmaScoreRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTopicInitialReputerEmaScore", data);
    return promise.then((data) => GetTopicInitialReputerEmaScoreResponse.decode(new BinaryReader(data)));
  }
}
