...
function createBaseParams(): Params {
  return {
    ...
    pNormSafeDiv: "",
    globalWhitelistEnabled: false,
    topicCreatorWhitelistEnabled: false,
    minExperiencedWorkerRegrets: "0",
    inferenceOutlierDetectionThreshold: "",
    inferenceOutlierDetectionAlpha: "",
    lambdaInitialScore: "",
    globalWorkerWhitelistEnabled: false,
    globalReputerWhitelistEnabled: false,
    globalAdminWhitelistAppended: false,
    maxWhitelistInputArrayLength: "0",
  };
}
...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.globalWhitelistEnabled !== false) {
      writer.uint32(400).bool(message.globalWhitelistEnabled);
    }
    if (message.topicCreatorWhitelistEnabled !== false) {
      writer.uint32(408).bool(message.topicCreatorWhitelistEnabled);
    }
    if (message.minExperiencedWorkerRegrets !== "0") {
      writer.uint32(416).uint64(message.minExperiencedWorkerRegrets);
    }
    if (message.inferenceOutlierDetectionThreshold !== "") {
      writer.uint32(426).string(message.inferenceOutlierDetectionThreshold);
    }
    if (message.inferenceOutlierDetectionAlpha !== "") {
      writer.uint32(434).string(message.inferenceOutlierDetectionAlpha);
    }
    if (message.lambdaInitialScore !== "") {
      writer.uint32(442).string(message.lambdaInitialScore);
    }
    if (message.globalWorkerWhitelistEnabled !== false) {
      writer.uint32(448).bool(message.globalWorkerWhitelistEnabled);
    }
    if (message.globalReputerWhitelistEnabled !== false) {
      writer.uint32(456).bool(message.globalReputerWhitelistEnabled);
    }
    if (message.globalAdminWhitelistAppended !== false) {
      writer.uint32(464).bool(message.globalAdminWhitelistAppended);
    }
    if (message.maxWhitelistInputArrayLength !== "0") {
      writer.uint32(472).uint64(message.maxWhitelistInputArrayLength);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 50: {
          ...
          message.globalWhitelistEnabled = reader.bool();
          continue;
        }
        case 51: {
          if (tag !== 408) {
          ...
          message.topicCreatorWhitelistEnabled = reader.bool();
          continue;
        }
        case 52: {
          if (tag !== 416) {
          ...
          message.minExperiencedWorkerRegrets = reader.uint64().toString();
          continue;
        }
        case 53: {
          if (tag !== 426) {
          ...
          message.inferenceOutlierDetectionThreshold = reader.string();
          continue;
        }
        case 54: {
          if (tag !== 434) {
          ...
          message.inferenceOutlierDetectionAlpha = reader.string();
          continue;
        }
        case 55: {
          if (tag !== 442) {
          ...
          message.lambdaInitialScore = reader.string();
          continue;
        }
        case 56: {
          if (tag !== 448) {
          ...
          message.globalWorkerWhitelistEnabled = reader.bool();
          continue;
        }
        case 57: {
          if (tag !== 456) {
          ...
          message.globalReputerWhitelistEnabled = reader.bool();
          continue;
        }
        case 58: {
          if (tag !== 464) {
          ...
          message.globalAdminWhitelistAppended = reader.bool();
          continue;
        }
        case 59: {
          if (tag !== 472) {
          ...
          message.maxWhitelistInputArrayLength = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      globalWhitelistEnabled: isSet(object.globalWhitelistEnabled)
        ? globalThis.Boolean(object.globalWhitelistEnabled)
        : false,
      topicCreatorWhitelistEnabled: isSet(object.topicCreatorWhitelistEnabled)
        ? globalThis.Boolean(object.topicCreatorWhitelistEnabled)
        : false,
      minExperiencedWorkerRegrets: isSet(object.minExperiencedWorkerRegrets)
        ? globalThis.String(object.minExperiencedWorkerRegrets)
        : "0",
      inferenceOutlierDetectionThreshold: isSet(object.inferenceOutlierDetectionThreshold)
        ? globalThis.String(object.inferenceOutlierDetectionThreshold)
        : "",
      inferenceOutlierDetectionAlpha: isSet(object.inferenceOutlierDetectionAlpha)
        ? globalThis.String(object.inferenceOutlierDetectionAlpha)
        : "",
      lambdaInitialScore: isSet(object.lambdaInitialScore) ? globalThis.String(object.lambdaInitialScore) : "",
      globalWorkerWhitelistEnabled: isSet(object.globalWorkerWhitelistEnabled)
        ? globalThis.Boolean(object.globalWorkerWhitelistEnabled)
        : false,
      globalReputerWhitelistEnabled: isSet(object.globalReputerWhitelistEnabled)
        ? globalThis.Boolean(object.globalReputerWhitelistEnabled)
        : false,
      globalAdminWhitelistAppended: isSet(object.globalAdminWhitelistAppended)
        ? globalThis.Boolean(object.globalAdminWhitelistAppended)
        : false,
      maxWhitelistInputArrayLength: isSet(object.maxWhitelistInputArrayLength)
        ? globalThis.String(object.maxWhitelistInputArrayLength)
        : "0",
    };
  },
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    message.globalWhitelistEnabled = object.globalWhitelistEnabled ?? false;
    message.topicCreatorWhitelistEnabled = object.topicCreatorWhitelistEnabled ?? false;
    message.minExperiencedWorkerRegrets = object.minExperiencedWorkerRegrets ?? "0";
    message.inferenceOutlierDetectionThreshold = object.inferenceOutlierDetectionThreshold ?? "";
    message.inferenceOutlierDetectionAlpha = object.inferenceOutlierDetectionAlpha ?? "";
    message.lambdaInitialScore = object.lambdaInitialScore ?? "";
    message.globalWorkerWhitelistEnabled = object.globalWorkerWhitelistEnabled ?? false;
    message.globalReputerWhitelistEnabled = object.globalReputerWhitelistEnabled ?? false;
    message.globalAdminWhitelistAppended = object.globalAdminWhitelistAppended ?? false;
    message.maxWhitelistInputArrayLength = object.maxWhitelistInputArrayLength ?? "0";
    return message;
  },
};
