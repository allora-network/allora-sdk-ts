...
export const protobufPackage = "emissions.v6";
...
export interface CanUpdateGlobalWhitelistsRequest {
  address: string;
}

export interface CanUpdateGlobalWhitelistsResponse {
  canUpdateGlobalWhitelists: boolean;
}
...
function createBaseCanUpdateGlobalWhitelistsRequest(): CanUpdateGlobalWhitelistsRequest {
  return { address: "" };
}

export const CanUpdateGlobalWhitelistsRequest: MessageFns<CanUpdateGlobalWhitelistsRequest> = {
  encode(message: CanUpdateGlobalWhitelistsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateGlobalWhitelistsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateGlobalWhitelistsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CanUpdateGlobalWhitelistsRequest {
    return { address: isSet(object.address) ? globalThis.String(object.address) : "" };
  },

  toJSON(message: CanUpdateGlobalWhitelistsRequest): unknown {
    const obj: any = {};
    if (message.address !== "") {
      obj.address = message.address;
    }
  ...
  create(base?: DeepPartial<CanUpdateGlobalWhitelistsRequest>): CanUpdateGlobalWhitelistsRequest {
    return CanUpdateGlobalWhitelistsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateGlobalWhitelistsRequest>): CanUpdateGlobalWhitelistsRequest {
    const message = createBaseCanUpdateGlobalWhitelistsRequest();
    message.address = object.address ?? "";
    return message;
  },
...
function createBaseCanUpdateGlobalWhitelistsResponse(): CanUpdateGlobalWhitelistsResponse {
  return { canUpdateGlobalWhitelists: false };
}

export const CanUpdateGlobalWhitelistsResponse: MessageFns<CanUpdateGlobalWhitelistsResponse> = {
  encode(message: CanUpdateGlobalWhitelistsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.canUpdateGlobalWhitelists !== false) {
      writer.uint32(8).bool(message.canUpdateGlobalWhitelists);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CanUpdateGlobalWhitelistsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCanUpdateGlobalWhitelistsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.canUpdateGlobalWhitelists = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CanUpdateGlobalWhitelistsResponse {
    return {
      canUpdateGlobalWhitelists: isSet(object.canUpdateGlobalWhitelists)
        ? globalThis.Boolean(object.canUpdateGlobalWhitelists)
        : false,
    };
  },

  toJSON(message: CanUpdateGlobalWhitelistsResponse): unknown {
    const obj: any = {};
    if (message.canUpdateGlobalWhitelists !== false) {
      obj.canUpdateGlobalWhitelists = message.canUpdateGlobalWhitelists;
    }
    return obj;
  },

  create(base?: DeepPartial<CanUpdateGlobalWhitelistsResponse>): CanUpdateGlobalWhitelistsResponse {
    return CanUpdateGlobalWhitelistsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CanUpdateGlobalWhitelistsResponse>): CanUpdateGlobalWhitelistsResponse {
    const message = createBaseCanUpdateGlobalWhitelistsResponse();
    message.canUpdateGlobalWhitelists = object.canUpdateGlobalWhitelists ?? false;
    return message;
  },
};
...
export interface QueryService {
  ...
  CanUpdateGlobalWhitelists(request: CanUpdateGlobalWhitelistsRequest): Promise<CanUpdateGlobalWhitelistsResponse>;
...
export const QueryServiceServiceName = "emissions.v6.QueryService";
export class QueryServiceClientImpl implements QueryService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.CanUpdateGlobalWhitelists = this.CanUpdateGlobalWhitelists.bind(this);
  ...
  CanUpdateGlobalWhitelists(request: CanUpdateGlobalWhitelistsRequest): Promise<CanUpdateGlobalWhitelistsResponse> {
    const data = CanUpdateGlobalWhitelistsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CanUpdateGlobalWhitelists", data);
    return promise.then((data) => CanUpdateGlobalWhitelistsResponse.decode(new BinaryReader(data)));
  }
