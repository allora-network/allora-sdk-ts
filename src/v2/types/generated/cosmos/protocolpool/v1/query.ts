...
export const QueryUnclaimedBudgetRequest: MessageFns<QueryUnclaimedBudgetRequest> = {
  encode(message: QueryUnclaimedBudgetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryUnclaimedBudgetRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryUnclaimedBudgetRequest>): QueryUnclaimedBudgetRequest {
    return QueryUnclaimedBudgetRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryUnclaimedBudgetRequest>): QueryUnclaimedBudgetRequest {
    const message = createBaseQueryUnclaimedBudgetRequest();
...
export const QueryUnclaimedBudgetResponse: MessageFns<QueryUnclaimedBudgetResponse> = {
  encode(message: QueryUnclaimedBudgetResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.totalBudget !== undefined) {
      Coin.encode(message.totalBudget, writer.uint32(10).fork()).join();
    }
    if (message.claimedAmount !== undefined) {
      Coin.encode(message.claimedAmount, writer.uint32(18).fork()).join();
    }
    if (message.unclaimedAmount !== undefined) {
      Coin.encode(message.unclaimedAmount, writer.uint32(26).fork()).join();
    }
    if (message.nextClaimFrom !== undefined) {
      Timestamp.encode(toTimestamp(message.nextClaimFrom), writer.uint32(34).fork()).join();
    }
    if (message.period !== undefined) {
      Duration.encode(message.period, writer.uint32(42).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryUnclaimedBudgetResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryUnclaimedBudgetResponse>): QueryUnclaimedBudgetResponse {
    return QueryUnclaimedBudgetResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryUnclaimedBudgetResponse>): QueryUnclaimedBudgetResponse {
    const message = createBaseQueryUnclaimedBudgetResponse();
...
export class QueryClientImpl implements Query {
  ...
  UnclaimedBudget(request: QueryUnclaimedBudgetRequest): Promise<QueryUnclaimedBudgetResponse> {
    ...
    return promise.then((data) => QueryUnclaimedBudgetResponse.decode(new BinaryReader(data)));
  }
}
