...
export const MsgPruneExpiredGrants: MessageFns<MsgPruneExpiredGrants> = {
  encode(message: MsgPruneExpiredGrants, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pruner !== "") {
...
export const MsgPruneExpiredGrantsResponse: MessageFns<MsgPruneExpiredGrantsResponse> = {
  encode(_: MsgPruneExpiredGrantsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
