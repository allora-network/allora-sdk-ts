...
export const QueryProposalVoteOptionsRequest: MessageFns<QueryProposalVoteOptionsRequest> = {
  encode(message: QueryProposalVoteOptionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.proposalId !== "0") {
      writer.uint32(8).uint64(message.proposalId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryProposalVoteOptionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryProposalVoteOptionsRequest>): QueryProposalVoteOptionsRequest {
    return QueryProposalVoteOptionsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryProposalVoteOptionsRequest>): QueryProposalVoteOptionsRequest {
    const message = createBaseQueryProposalVoteOptionsRequest();
    message.proposalId = object.proposalId ?? "0";
    return message;
  },
...
export const QueryProposalVoteOptionsResponse: MessageFns<QueryProposalVoteOptionsResponse> = {
  encode(message: QueryProposalVoteOptionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.voteOptions !== undefined) {
      ProposalVoteOptions.encode(message.voteOptions, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryProposalVoteOptionsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryProposalVoteOptionsResponse>): QueryProposalVoteOptionsResponse {
    return QueryProposalVoteOptionsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryProposalVoteOptionsResponse>): QueryProposalVoteOptionsResponse {
    const message = createBaseQueryProposalVoteOptionsResponse();
...
export const QueryMessageBasedParamsRequest: MessageFns<QueryMessageBasedParamsRequest> = {
  encode(message: QueryMessageBasedParamsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msgUrl !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryMessageBasedParamsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryMessageBasedParamsRequest>): QueryMessageBasedParamsRequest {
    return QueryMessageBasedParamsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryMessageBasedParamsRequest>): QueryMessageBasedParamsRequest {
    const message = createBaseQueryMessageBasedParamsRequest();
...
export const QueryMessageBasedParamsResponse: MessageFns<QueryMessageBasedParamsResponse> = {
  encode(message: QueryMessageBasedParamsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.params !== undefined) {
      MessageBasedParams.encode(message.params, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryMessageBasedParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<QueryMessageBasedParamsResponse>): QueryMessageBasedParamsResponse {
    return QueryMessageBasedParamsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryMessageBasedParamsResponse>): QueryMessageBasedParamsResponse {
    const message = createBaseQueryMessageBasedParamsResponse();
    message.params = (object.params !== undefined && object.params !== null)
...
export class QueryClientImpl implements Query {
  ...
  ProposalVoteOptions(request: QueryProposalVoteOptionsRequest): Promise<QueryProposalVoteOptionsResponse> {
    ...
    return promise.then((data) => QueryProposalVoteOptionsResponse.decode(new BinaryReader(data)));
  }
  ...
  MessageBasedParams(request: QueryMessageBasedParamsRequest): Promise<QueryMessageBasedParamsResponse> {
    ...
    return promise.then((data) => QueryMessageBasedParamsResponse.decode(new BinaryReader(data)));
  }
}
