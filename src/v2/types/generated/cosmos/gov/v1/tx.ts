...
export const MsgSubmitMultipleChoiceProposal: MessageFns<MsgSubmitMultipleChoiceProposal> = {
  encode(message: MsgSubmitMultipleChoiceProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.initialDeposit) {
    ...
    if (message.voteOptions !== undefined) {
      ProposalVoteOptions.encode(message.voteOptions, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubmitMultipleChoiceProposal {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<MsgSubmitMultipleChoiceProposal>): MsgSubmitMultipleChoiceProposal {
    return MsgSubmitMultipleChoiceProposal.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MsgSubmitMultipleChoiceProposal>): MsgSubmitMultipleChoiceProposal {
    const message = createBaseMsgSubmitMultipleChoiceProposal();
    message.initialDeposit = object.initialDeposit?.map((e) => Coin.fromPartial(e)) || [];
    message.proposer = object.proposer ?? "";
    message.metadata = object.metadata ?? "";
...
export const MsgSubmitMultipleChoiceProposalResponse: MessageFns<MsgSubmitMultipleChoiceProposalResponse> = {
  encode(message: MsgSubmitMultipleChoiceProposalResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.proposalId !== "0") {
      writer.uint32(8).uint64(message.proposalId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubmitMultipleChoiceProposalResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<MsgSubmitMultipleChoiceProposalResponse>): MsgSubmitMultipleChoiceProposalResponse {
    return MsgSubmitMultipleChoiceProposalResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MsgSubmitMultipleChoiceProposalResponse>): MsgSubmitMultipleChoiceProposalResponse {
    const message = createBaseMsgSubmitMultipleChoiceProposalResponse();
    message.proposalId = object.proposalId ?? "0";
    return message;
  },
...
export const MsgUpdateMessageParams: MessageFns<MsgUpdateMessageParams> = {
  encode(message: MsgUpdateMessageParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.msgUrl !== "") {
    ...
    if (message.params !== undefined) {
      MessageBasedParams.encode(message.params, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateMessageParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<MsgUpdateMessageParams>): MsgUpdateMessageParams {
    return MsgUpdateMessageParams.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MsgUpdateMessageParams>): MsgUpdateMessageParams {
    const message = createBaseMsgUpdateMessageParams();
    message.authority = object.authority ?? "";
...
export const MsgUpdateMessageParamsResponse: MessageFns<MsgUpdateMessageParamsResponse> = {
  encode(_: MsgUpdateMessageParamsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateMessageParamsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<MsgUpdateMessageParamsResponse>): MsgUpdateMessageParamsResponse {
    return MsgUpdateMessageParamsResponse.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<MsgUpdateMessageParamsResponse>): MsgUpdateMessageParamsResponse {
    const message = createBaseMsgUpdateMessageParamsResponse();
    return message;
  },
};
...
export const MsgSudoExec: MessageFns<MsgSudoExec> = {
  encode(message: MsgSudoExec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSudoExec {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<MsgSudoExec>): MsgSudoExec {
    return MsgSudoExec.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MsgSudoExec>): MsgSudoExec {
    const message = createBaseMsgSudoExec();
    message.authority = object.authority ?? "";
...
export const MsgSudoExecResponse: MessageFns<MsgSudoExecResponse> = {
  encode(message: MsgSudoExecResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSudoExecResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<MsgSudoExecResponse>): MsgSudoExecResponse {
    return MsgSudoExecResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MsgSudoExecResponse>): MsgSudoExecResponse {
    const message = createBaseMsgSudoExecResponse();
...
export class MsgClientImpl implements Msg {
  ...
  SubmitMultipleChoiceProposal(
    ...
    return promise.then((data) => MsgSubmitMultipleChoiceProposalResponse.decode(new BinaryReader(data)));
  }
  ...
  UpdateMessageParams(request: MsgUpdateMessageParams): Promise<MsgUpdateMessageParamsResponse> {
    ...
    return promise.then((data) => MsgUpdateMessageParamsResponse.decode(new BinaryReader(data)));
  }

  SudoExec(request: MsgSudoExec): Promise<MsgSudoExecResponse> {
    const data = MsgSudoExec.encode(request).finish();
    const promise = this.rpc.request(this.service, "SudoExec", data);
    return promise.then((data) => MsgSudoExecResponse.decode(new BinaryReader(data)));
  }
}
