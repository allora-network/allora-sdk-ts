...
export const Proposal: MessageFns<Proposal> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.groupVersion = reader.uint64().toString();
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.groupPolicyVersion = reader.uint64().toString();
          continue;
        }
        case 8: {
          if (tag !== 64) {
  ...
  fromJSON(object: any): Proposal {
    return {
      ...
      groupVersion: isSet(object.groupVersion) ? globalThis.String(object.groupVersion) : "0",
      groupPolicyVersion: isSet(object.groupPolicyVersion) ? globalThis.String(object.groupPolicyVersion) : "0",
