...
export const ProposalVoteOptions: MessageFns<ProposalVoteOptions> = {
  encode(message: ProposalVoteOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProposalVoteOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<ProposalVoteOptions>): ProposalVoteOptions {
    return ProposalVoteOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ProposalVoteOptions>): ProposalVoteOptions {
    const message = createBaseProposalVoteOptions();
...
export const TallyResult: MessageFns<TallyResult> = {
  ...
  fromPartial(object: DeepPartial<TallyResult>): TallyResult {
    ...
    message.optionOneCount = object.optionOneCount ?? "";
    message.optionTwoCount = object.optionTwoCount ?? "";
    message.optionThreeCount = object.optionThreeCount ?? "";
    message.optionFourCount = object.optionFourCount ?? "";
...
export const MessageBasedParams: MessageFns<MessageBasedParams> = {
  encode(message: MessageBasedParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.votingPeriod !== undefined) {
      Duration.encode(message.votingPeriod, writer.uint32(10).fork()).join();
    }
    if (message.quorum !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MessageBasedParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<MessageBasedParams>): MessageBasedParams {
    return MessageBasedParams.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MessageBasedParams>): MessageBasedParams {
    const message = createBaseMessageBasedParams();
    message.votingPeriod = (object.votingPeriod !== undefined && object.votingPeriod !== null)
      ? Duration.fromPartial(object.votingPeriod)
      : undefined;
