...
export const HistoricalRecord: MessageFns<HistoricalRecord> = {
  encode(message: HistoricalRecord, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create(base?: DeepPartial<HistoricalRecord>): HistoricalRecord {
    return HistoricalRecord.fromPartial(base ?? {});
  },
...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.keyRotationFee !== undefined) {
      Coin.encode(message.keyRotationFee, writer.uint32(58).fork()).join();
    }
    return writer;
  },
...
export const ConsPubKeyRotationHistory: MessageFns<ConsPubKeyRotationHistory> = {
  encode(message: ConsPubKeyRotationHistory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.operatorAddress.length !== 0) {
      writer.uint32(10).bytes(message.operatorAddress);
    }
    if (message.oldConsPubkey !== undefined) {
      Any.encode(message.oldConsPubkey, writer.uint32(18).fork()).join();
    }
    if (message.newConsPubkey !== undefined) {
      Any.encode(message.newConsPubkey, writer.uint32(26).fork()).join();
    }
    if (message.height !== "0") {
      writer.uint32(32).uint64(message.height);
    }
    if (message.fee !== undefined) {
      Coin.encode(message.fee, writer.uint32(42).fork()).join();
    }
    return writer;
  },
  ...
  create(base?: DeepPartial<ConsPubKeyRotationHistory>): ConsPubKeyRotationHistory {
    return ConsPubKeyRotationHistory.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ConsPubKeyRotationHistory>): ConsPubKeyRotationHistory {
    const message = createBaseConsPubKeyRotationHistory();
...
export const ValAddrsOfRotatedConsKeys: MessageFns<ValAddrsOfRotatedConsKeys> = {
  encode(message: ValAddrsOfRotatedConsKeys, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.addresses) {
  ...
  create(base?: DeepPartial<ValAddrsOfRotatedConsKeys>): ValAddrsOfRotatedConsKeys {
    return ValAddrsOfRotatedConsKeys.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ValAddrsOfRotatedConsKeys>): ValAddrsOfRotatedConsKeys {
    const message = createBaseValAddrsOfRotatedConsKeys();
    message.addresses = object.addresses?.map((e) => e) || [];
    return message;
  },
