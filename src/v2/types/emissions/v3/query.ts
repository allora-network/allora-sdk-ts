...
function createBaseQueryLatestAvailableNetworkInferencesRequest(): QueryLatestAvailableNetworkInferencesRequest {
  return { topicId: "0" };
}

export const QueryLatestAvailableNetworkInferencesRequest: MessageFns<QueryLatestAvailableNetworkInferencesRequest> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryLatestAvailableNetworkInferencesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryLatestAvailableNetworkInferencesRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryLatestAvailableNetworkInferencesRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryLatestAvailableNetworkInferencesRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(
    base?: DeepPartial<QueryLatestAvailableNetworkInferencesRequest>,
  ): QueryLatestAvailableNetworkInferencesRequest {
    return QueryLatestAvailableNetworkInferencesRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryLatestAvailableNetworkInferencesRequest>,
  ): QueryLatestAvailableNetworkInferencesRequest {
    const message = createBaseQueryLatestAvailableNetworkInferencesRequest();
    message.topicId = object.topicId ?? "0";
    return message;
...
function createBaseQueryLatestAvailableNetworkInferencesResponse(): QueryLatestAvailableNetworkInferencesResponse {
  return {
    networkInferences: undefined,
    infererWeights: [],
    forecasterWeights: [],
...
export const QueryLatestAvailableNetworkInferencesResponse: MessageFns<QueryLatestAvailableNetworkInferencesResponse> =
  {
    encode(
      message: QueryLatestAvailableNetworkInferencesResponse,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.networkInferences !== undefined) {
        ValueBundle.encode(message.networkInferences, writer.uint32(10).fork()).join();
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): QueryLatestAvailableNetworkInferencesResponse {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseQueryLatestAvailableNetworkInferencesResponse();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    fromJSON(object: any): QueryLatestAvailableNetworkInferencesResponse {
      return {
        networkInferences: isSet(object.networkInferences) ? ValueBundle.fromJSON(object.networkInferences) : undefined,
        infererWeights: globalThis.Array.isArray(object?.infererWeights)
          ? object.infererWeights.map((e: any) => RegretInformedWeight.fromJSON(e))
    ...
    toJSON(message: QueryLatestAvailableNetworkInferencesResponse): unknown {
      const obj: any = {};
      if (message.networkInferences !== undefined) {
        obj.networkInferences = ValueBundle.toJSON(message.networkInferences);
      }
    ...
    create(
      base?: DeepPartial<QueryLatestAvailableNetworkInferencesResponse>,
    ): QueryLatestAvailableNetworkInferencesResponse {
      return QueryLatestAvailableNetworkInferencesResponse.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<QueryLatestAvailableNetworkInferencesResponse>,
    ): QueryLatestAvailableNetworkInferencesResponse {
      const message = createBaseQueryLatestAvailableNetworkInferencesResponse();
      message.networkInferences = (object.networkInferences !== undefined && object.networkInferences !== null)
        ? ValueBundle.fromPartial(object.networkInferences)
...
function createBaseQueryTopicLastWorkerCommitInfoRequest(): QueryTopicLastWorkerCommitInfoRequest {
  return { topicId: "0" };
}

export const QueryTopicLastWorkerCommitInfoRequest: MessageFns<QueryTopicLastWorkerCommitInfoRequest> = {
  encode(message: QueryTopicLastWorkerCommitInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTopicLastWorkerCommitInfoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryTopicLastWorkerCommitInfoRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryTopicLastWorkerCommitInfoRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryTopicLastWorkerCommitInfoRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryTopicLastWorkerCommitInfoRequest>): QueryTopicLastWorkerCommitInfoRequest {
    return QueryTopicLastWorkerCommitInfoRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryTopicLastWorkerCommitInfoRequest>): QueryTopicLastWorkerCommitInfoRequest {
    const message = createBaseQueryTopicLastWorkerCommitInfoRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseQueryTopicLastWorkerCommitInfoResponse(): QueryTopicLastWorkerCommitInfoResponse {
  return { lastCommit: undefined };
}

export const QueryTopicLastWorkerCommitInfoResponse: MessageFns<QueryTopicLastWorkerCommitInfoResponse> = {
  encode(message: QueryTopicLastWorkerCommitInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTopicLastWorkerCommitInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryTopicLastWorkerCommitInfoResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryTopicLastWorkerCommitInfoResponse {
    return { lastCommit: isSet(object.lastCommit) ? TimestampedActorNonce.fromJSON(object.lastCommit) : undefined };
  },

  toJSON(message: QueryTopicLastWorkerCommitInfoResponse): unknown {
    const obj: any = {};
    if (message.lastCommit !== undefined) {
  ...
  create(base?: DeepPartial<QueryTopicLastWorkerCommitInfoResponse>): QueryTopicLastWorkerCommitInfoResponse {
    return QueryTopicLastWorkerCommitInfoResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryTopicLastWorkerCommitInfoResponse>): QueryTopicLastWorkerCommitInfoResponse {
    const message = createBaseQueryTopicLastWorkerCommitInfoResponse();
...
function createBaseQueryTopicLastReputerCommitInfoRequest(): QueryTopicLastReputerCommitInfoRequest {
  return { topicId: "0" };
}

export const QueryTopicLastReputerCommitInfoRequest: MessageFns<QueryTopicLastReputerCommitInfoRequest> = {
  encode(message: QueryTopicLastReputerCommitInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTopicLastReputerCommitInfoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryTopicLastReputerCommitInfoRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryTopicLastReputerCommitInfoRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryTopicLastReputerCommitInfoRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryTopicLastReputerCommitInfoRequest>): QueryTopicLastReputerCommitInfoRequest {
    return QueryTopicLastReputerCommitInfoRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryTopicLastReputerCommitInfoRequest>): QueryTopicLastReputerCommitInfoRequest {
    const message = createBaseQueryTopicLastReputerCommitInfoRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseQueryTopicLastReputerCommitInfoResponse(): QueryTopicLastReputerCommitInfoResponse {
  return { lastCommit: undefined };
}

export const QueryTopicLastReputerCommitInfoResponse: MessageFns<QueryTopicLastReputerCommitInfoResponse> = {
  encode(message: QueryTopicLastReputerCommitInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.lastCommit !== undefined) {
      TimestampedActorNonce.encode(message.lastCommit, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTopicLastReputerCommitInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryTopicLastReputerCommitInfoResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryTopicLastReputerCommitInfoResponse {
    return { lastCommit: isSet(object.lastCommit) ? TimestampedActorNonce.fromJSON(object.lastCommit) : undefined };
  },

  toJSON(message: QueryTopicLastReputerCommitInfoResponse): unknown {
    const obj: any = {};
    if (message.lastCommit !== undefined) {
      obj.lastCommit = TimestampedActorNonce.toJSON(message.lastCommit);
    }
  ...
  create(base?: DeepPartial<QueryTopicLastReputerCommitInfoResponse>): QueryTopicLastReputerCommitInfoResponse {
    return QueryTopicLastReputerCommitInfoResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryTopicLastReputerCommitInfoResponse>): QueryTopicLastReputerCommitInfoResponse {
    const message = createBaseQueryTopicLastReputerCommitInfoResponse();
    message.lastCommit = (object.lastCommit !== undefined && object.lastCommit !== null)
      ? TimestampedActorNonce.fromPartial(object.lastCommit)
      : undefined;
...
function createBaseQueryGetInfererScoreEmaRequest(): QueryGetInfererScoreEmaRequest {
  return { topicId: "0", inferer: "" };
}

export const QueryGetInfererScoreEmaRequest: MessageFns<QueryGetInfererScoreEmaRequest> = {
  encode(message: QueryGetInfererScoreEmaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.inferer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetInfererScoreEmaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetInfererScoreEmaRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetInfererScoreEmaRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      inferer: isSet(object.inferer) ? globalThis.String(object.inferer) : "",
    };
  ...
  toJSON(message: QueryGetInfererScoreEmaRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryGetInfererScoreEmaRequest>): QueryGetInfererScoreEmaRequest {
    return QueryGetInfererScoreEmaRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryGetInfererScoreEmaRequest>): QueryGetInfererScoreEmaRequest {
    const message = createBaseQueryGetInfererScoreEmaRequest();
    message.topicId = object.topicId ?? "0";
    message.inferer = object.inferer ?? "";
    return message;
...
function createBaseQueryGetInfererScoreEmaResponse(): QueryGetInfererScoreEmaResponse {
  return { score: undefined };
}

export const QueryGetInfererScoreEmaResponse: MessageFns<QueryGetInfererScoreEmaResponse> = {
  encode(message: QueryGetInfererScoreEmaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetInfererScoreEmaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetInfererScoreEmaResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetInfererScoreEmaResponse {
    return { score: isSet(object.score) ? Score.fromJSON(object.score) : undefined };
  },

  toJSON(message: QueryGetInfererScoreEmaResponse): unknown {
    const obj: any = {};
    if (message.score !== undefined) {
  ...
  create(base?: DeepPartial<QueryGetInfererScoreEmaResponse>): QueryGetInfererScoreEmaResponse {
    return QueryGetInfererScoreEmaResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryGetInfererScoreEmaResponse>): QueryGetInfererScoreEmaResponse {
    const message = createBaseQueryGetInfererScoreEmaResponse();
...
function createBaseQueryGetForecasterScoreEmaRequest(): QueryGetForecasterScoreEmaRequest {
  return { topicId: "0", forecaster: "" };
}

export const QueryGetForecasterScoreEmaRequest: MessageFns<QueryGetForecasterScoreEmaRequest> = {
  encode(message: QueryGetForecasterScoreEmaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.forecaster !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetForecasterScoreEmaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetForecasterScoreEmaRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetForecasterScoreEmaRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      forecaster: isSet(object.forecaster) ? globalThis.String(object.forecaster) : "",
    };
  ...
  toJSON(message: QueryGetForecasterScoreEmaRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryGetForecasterScoreEmaRequest>): QueryGetForecasterScoreEmaRequest {
    return QueryGetForecasterScoreEmaRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryGetForecasterScoreEmaRequest>): QueryGetForecasterScoreEmaRequest {
    const message = createBaseQueryGetForecasterScoreEmaRequest();
    message.topicId = object.topicId ?? "0";
    message.forecaster = object.forecaster ?? "";
    return message;
...
function createBaseQueryGetForecasterScoreEmaResponse(): QueryGetForecasterScoreEmaResponse {
  return { score: undefined };
}

export const QueryGetForecasterScoreEmaResponse: MessageFns<QueryGetForecasterScoreEmaResponse> = {
  encode(message: QueryGetForecasterScoreEmaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== undefined) {
      Score.encode(message.score, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetForecasterScoreEmaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetForecasterScoreEmaResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetForecasterScoreEmaResponse {
    return { score: isSet(object.score) ? Score.fromJSON(object.score) : undefined };
  },

  toJSON(message: QueryGetForecasterScoreEmaResponse): unknown {
    const obj: any = {};
    if (message.score !== undefined) {
      obj.score = Score.toJSON(message.score);
    }
  ...
  create(base?: DeepPartial<QueryGetForecasterScoreEmaResponse>): QueryGetForecasterScoreEmaResponse {
    return QueryGetForecasterScoreEmaResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryGetForecasterScoreEmaResponse>): QueryGetForecasterScoreEmaResponse {
    const message = createBaseQueryGetForecasterScoreEmaResponse();
    message.score = (object.score !== undefined && object.score !== null) ? Score.fromPartial(object.score) : undefined;
    return message;
  },
...
function createBaseQueryGetReputerScoreEmaRequest(): QueryGetReputerScoreEmaRequest {
  return { topicId: "0", reputer: "" };
}

export const QueryGetReputerScoreEmaRequest: MessageFns<QueryGetReputerScoreEmaRequest> = {
  encode(message: QueryGetReputerScoreEmaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.reputer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetReputerScoreEmaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetReputerScoreEmaRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetReputerScoreEmaRequest {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      reputer: isSet(object.reputer) ? globalThis.String(object.reputer) : "",
    };
  ...
  toJSON(message: QueryGetReputerScoreEmaRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryGetReputerScoreEmaRequest>): QueryGetReputerScoreEmaRequest {
    return QueryGetReputerScoreEmaRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryGetReputerScoreEmaRequest>): QueryGetReputerScoreEmaRequest {
    const message = createBaseQueryGetReputerScoreEmaRequest();
    message.topicId = object.topicId ?? "0";
    message.reputer = object.reputer ?? "";
    return message;
...
function createBaseQueryGetReputerScoreEmaResponse(): QueryGetReputerScoreEmaResponse {
  return { score: undefined };
}

export const QueryGetReputerScoreEmaResponse: MessageFns<QueryGetReputerScoreEmaResponse> = {
  encode(message: QueryGetReputerScoreEmaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== undefined) {
      Score.encode(message.score, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetReputerScoreEmaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetReputerScoreEmaResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetReputerScoreEmaResponse {
    return { score: isSet(object.score) ? Score.fromJSON(object.score) : undefined };
  },

  toJSON(message: QueryGetReputerScoreEmaResponse): unknown {
    const obj: any = {};
    if (message.score !== undefined) {
      obj.score = Score.toJSON(message.score);
    }
  ...
  create(base?: DeepPartial<QueryGetReputerScoreEmaResponse>): QueryGetReputerScoreEmaResponse {
    return QueryGetReputerScoreEmaResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryGetReputerScoreEmaResponse>): QueryGetReputerScoreEmaResponse {
    const message = createBaseQueryGetReputerScoreEmaResponse();
    message.score = (object.score !== undefined && object.score !== null) ? Score.fromPartial(object.score) : undefined;
    return message;
  },
...
function createBaseQueryGetPreviousTopicQuantileForecasterScoreEmaRequest(): QueryGetPreviousTopicQuantileForecasterScoreEmaRequest {
  return { topicId: "0" };
}

export const QueryGetPreviousTopicQuantileForecasterScoreEmaRequest: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetPreviousTopicQuantileForecasterScoreEmaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetPreviousTopicQuantileForecasterScoreEmaRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetPreviousTopicQuantileForecasterScoreEmaRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryGetPreviousTopicQuantileForecasterScoreEmaRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(
    base?: DeepPartial<QueryGetPreviousTopicQuantileForecasterScoreEmaRequest>,
  ): QueryGetPreviousTopicQuantileForecasterScoreEmaRequest {
    return QueryGetPreviousTopicQuantileForecasterScoreEmaRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryGetPreviousTopicQuantileForecasterScoreEmaRequest>,
  ): QueryGetPreviousTopicQuantileForecasterScoreEmaRequest {
    const message = createBaseQueryGetPreviousTopicQuantileForecasterScoreEmaRequest();
    message.topicId = object.topicId ?? "0";
    return message;
...
function createBaseQueryGetPreviousTopicQuantileForecasterScoreEmaResponse(): QueryGetPreviousTopicQuantileForecasterScoreEmaResponse {
  return { value: "" };
}

export const QueryGetPreviousTopicQuantileForecasterScoreEmaResponse: MessageFns<
  QueryGetPreviousTopicQuantileForecasterScoreEmaResponse
> = {
  encode(
    message: QueryGetPreviousTopicQuantileForecasterScoreEmaResponse,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetPreviousTopicQuantileForecasterScoreEmaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetPreviousTopicQuantileForecasterScoreEmaResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetPreviousTopicQuantileForecasterScoreEmaResponse {
    return { value: isSet(object.value) ? globalThis.String(object.value) : "" };
  },

  toJSON(message: QueryGetPreviousTopicQuantileForecasterScoreEmaResponse): unknown {
    const obj: any = {};
    if (message.value !== "") {
  ...
  create(
    base?: DeepPartial<QueryGetPreviousTopicQuantileForecasterScoreEmaResponse>,
  ): QueryGetPreviousTopicQuantileForecasterScoreEmaResponse {
    return QueryGetPreviousTopicQuantileForecasterScoreEmaResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryGetPreviousTopicQuantileForecasterScoreEmaResponse>,
  ): QueryGetPreviousTopicQuantileForecasterScoreEmaResponse {
    const message = createBaseQueryGetPreviousTopicQuantileForecasterScoreEmaResponse();
...
function createBaseQueryGetPreviousTopicQuantileInfererScoreEmaRequest(): QueryGetPreviousTopicQuantileInfererScoreEmaRequest {
  return { topicId: "0" };
}

export const QueryGetPreviousTopicQuantileInfererScoreEmaRequest: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetPreviousTopicQuantileInfererScoreEmaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetPreviousTopicQuantileInfererScoreEmaRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetPreviousTopicQuantileInfererScoreEmaRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryGetPreviousTopicQuantileInfererScoreEmaRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(
    base?: DeepPartial<QueryGetPreviousTopicQuantileInfererScoreEmaRequest>,
  ): QueryGetPreviousTopicQuantileInfererScoreEmaRequest {
    return QueryGetPreviousTopicQuantileInfererScoreEmaRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryGetPreviousTopicQuantileInfererScoreEmaRequest>,
  ): QueryGetPreviousTopicQuantileInfererScoreEmaRequest {
    const message = createBaseQueryGetPreviousTopicQuantileInfererScoreEmaRequest();
    message.topicId = object.topicId ?? "0";
    return message;
...
function createBaseQueryGetPreviousTopicQuantileInfererScoreEmaResponse(): QueryGetPreviousTopicQuantileInfererScoreEmaResponse {
  return { value: "" };
}

export const QueryGetPreviousTopicQuantileInfererScoreEmaResponse: MessageFns<
  QueryGetPreviousTopicQuantileInfererScoreEmaResponse
> = {
  encode(
    message: QueryGetPreviousTopicQuantileInfererScoreEmaResponse,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.value !== "") {
      writer.uint32(10).string(message.value);
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetPreviousTopicQuantileInfererScoreEmaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetPreviousTopicQuantileInfererScoreEmaResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetPreviousTopicQuantileInfererScoreEmaResponse {
    return { value: isSet(object.value) ? globalThis.String(object.value) : "" };
  },

  toJSON(message: QueryGetPreviousTopicQuantileInfererScoreEmaResponse): unknown {
    const obj: any = {};
    if (message.value !== "") {
      obj.value = message.value;
    }
  ...
  create(
    base?: DeepPartial<QueryGetPreviousTopicQuantileInfererScoreEmaResponse>,
  ): QueryGetPreviousTopicQuantileInfererScoreEmaResponse {
    return QueryGetPreviousTopicQuantileInfererScoreEmaResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryGetPreviousTopicQuantileInfererScoreEmaResponse>,
  ): QueryGetPreviousTopicQuantileInfererScoreEmaResponse {
    const message = createBaseQueryGetPreviousTopicQuantileInfererScoreEmaResponse();
    message.value = object.value ?? "";
    return message;
...
function createBaseQueryGetPreviousTopicQuantileReputerScoreEmaRequest(): QueryGetPreviousTopicQuantileReputerScoreEmaRequest {
  return { topicId: "0" };
}

export const QueryGetPreviousTopicQuantileReputerScoreEmaRequest: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetPreviousTopicQuantileReputerScoreEmaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetPreviousTopicQuantileReputerScoreEmaRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetPreviousTopicQuantileReputerScoreEmaRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryGetPreviousTopicQuantileReputerScoreEmaRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(
    base?: DeepPartial<QueryGetPreviousTopicQuantileReputerScoreEmaRequest>,
  ): QueryGetPreviousTopicQuantileReputerScoreEmaRequest {
    return QueryGetPreviousTopicQuantileReputerScoreEmaRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryGetPreviousTopicQuantileReputerScoreEmaRequest>,
  ): QueryGetPreviousTopicQuantileReputerScoreEmaRequest {
    const message = createBaseQueryGetPreviousTopicQuantileReputerScoreEmaRequest();
    message.topicId = object.topicId ?? "0";
    return message;
...
function createBaseQueryGetPreviousTopicQuantileReputerScoreEmaResponse(): QueryGetPreviousTopicQuantileReputerScoreEmaResponse {
  return { value: "" };
}

export const QueryGetPreviousTopicQuantileReputerScoreEmaResponse: MessageFns<
  QueryGetPreviousTopicQuantileReputerScoreEmaResponse
> = {
  encode(
    message: QueryGetPreviousTopicQuantileReputerScoreEmaResponse,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.value !== "") {
      writer.uint32(10).string(message.value);
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGetPreviousTopicQuantileReputerScoreEmaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetPreviousTopicQuantileReputerScoreEmaResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryGetPreviousTopicQuantileReputerScoreEmaResponse {
    return { value: isSet(object.value) ? globalThis.String(object.value) : "" };
  },

  toJSON(message: QueryGetPreviousTopicQuantileReputerScoreEmaResponse): unknown {
    const obj: any = {};
    if (message.value !== "") {
      obj.value = message.value;
    }
  ...
  create(
    base?: DeepPartial<QueryGetPreviousTopicQuantileReputerScoreEmaResponse>,
  ): QueryGetPreviousTopicQuantileReputerScoreEmaResponse {
    return QueryGetPreviousTopicQuantileReputerScoreEmaResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryGetPreviousTopicQuantileReputerScoreEmaResponse>,
  ): QueryGetPreviousTopicQuantileReputerScoreEmaResponse {
    const message = createBaseQueryGetPreviousTopicQuantileReputerScoreEmaResponse();
    message.value = object.value ?? "";
    return message;
...
function createBaseQueryCurrentLowestInfererScoreRequest(): QueryCurrentLowestInfererScoreRequest {
  return { topicId: "0" };
}

export const QueryCurrentLowestInfererScoreRequest: MessageFns<QueryCurrentLowestInfererScoreRequest> = {
  encode(message: QueryCurrentLowestInfererScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentLowestInfererScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCurrentLowestInfererScoreRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryCurrentLowestInfererScoreRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryCurrentLowestInfererScoreRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryCurrentLowestInfererScoreRequest>): QueryCurrentLowestInfererScoreRequest {
    return QueryCurrentLowestInfererScoreRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryCurrentLowestInfererScoreRequest>): QueryCurrentLowestInfererScoreRequest {
    const message = createBaseQueryCurrentLowestInfererScoreRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseQueryCurrentLowestInfererScoreResponse(): QueryCurrentLowestInfererScoreResponse {
  return { score: undefined };
}

export const QueryCurrentLowestInfererScoreResponse: MessageFns<QueryCurrentLowestInfererScoreResponse> = {
  encode(message: QueryCurrentLowestInfererScoreResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== undefined) {
      Score.encode(message.score, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentLowestInfererScoreResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCurrentLowestInfererScoreResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryCurrentLowestInfererScoreResponse {
    return { score: isSet(object.score) ? Score.fromJSON(object.score) : undefined };
  },

  toJSON(message: QueryCurrentLowestInfererScoreResponse): unknown {
    const obj: any = {};
    if (message.score !== undefined) {
      obj.score = Score.toJSON(message.score);
    }
  ...
  create(base?: DeepPartial<QueryCurrentLowestInfererScoreResponse>): QueryCurrentLowestInfererScoreResponse {
    return QueryCurrentLowestInfererScoreResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryCurrentLowestInfererScoreResponse>): QueryCurrentLowestInfererScoreResponse {
    const message = createBaseQueryCurrentLowestInfererScoreResponse();
    message.score = (object.score !== undefined && object.score !== null) ? Score.fromPartial(object.score) : undefined;
    return message;
  },
...
function createBaseQueryCurrentLowestForecasterScoreRequest(): QueryCurrentLowestForecasterScoreRequest {
  return { topicId: "0" };
}

export const QueryCurrentLowestForecasterScoreRequest: MessageFns<QueryCurrentLowestForecasterScoreRequest> = {
  encode(message: QueryCurrentLowestForecasterScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentLowestForecasterScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCurrentLowestForecasterScoreRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryCurrentLowestForecasterScoreRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryCurrentLowestForecasterScoreRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryCurrentLowestForecasterScoreRequest>): QueryCurrentLowestForecasterScoreRequest {
    return QueryCurrentLowestForecasterScoreRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryCurrentLowestForecasterScoreRequest>): QueryCurrentLowestForecasterScoreRequest {
    const message = createBaseQueryCurrentLowestForecasterScoreRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseQueryCurrentLowestForecasterScoreResponse(): QueryCurrentLowestForecasterScoreResponse {
  return { score: undefined };
}

export const QueryCurrentLowestForecasterScoreResponse: MessageFns<QueryCurrentLowestForecasterScoreResponse> = {
  encode(message: QueryCurrentLowestForecasterScoreResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== undefined) {
      Score.encode(message.score, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentLowestForecasterScoreResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCurrentLowestForecasterScoreResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryCurrentLowestForecasterScoreResponse {
    return { score: isSet(object.score) ? Score.fromJSON(object.score) : undefined };
  },

  toJSON(message: QueryCurrentLowestForecasterScoreResponse): unknown {
    const obj: any = {};
    if (message.score !== undefined) {
      obj.score = Score.toJSON(message.score);
    }
  ...
  create(base?: DeepPartial<QueryCurrentLowestForecasterScoreResponse>): QueryCurrentLowestForecasterScoreResponse {
    return QueryCurrentLowestForecasterScoreResponse.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<QueryCurrentLowestForecasterScoreResponse>,
...
function createBaseQueryCurrentLowestReputerScoreRequest(): QueryCurrentLowestReputerScoreRequest {
  return { topicId: "0" };
}

export const QueryCurrentLowestReputerScoreRequest: MessageFns<QueryCurrentLowestReputerScoreRequest> = {
  encode(message: QueryCurrentLowestReputerScoreRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentLowestReputerScoreRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCurrentLowestReputerScoreRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryCurrentLowestReputerScoreRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryCurrentLowestReputerScoreRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryCurrentLowestReputerScoreRequest>): QueryCurrentLowestReputerScoreRequest {
    return QueryCurrentLowestReputerScoreRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryCurrentLowestReputerScoreRequest>): QueryCurrentLowestReputerScoreRequest {
    const message = createBaseQueryCurrentLowestReputerScoreRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseQueryCurrentLowestReputerScoreResponse(): QueryCurrentLowestReputerScoreResponse {
  return { score: undefined };
}

export const QueryCurrentLowestReputerScoreResponse: MessageFns<QueryCurrentLowestReputerScoreResponse> = {
  encode(message: QueryCurrentLowestReputerScoreResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.score !== undefined) {
      Score.encode(message.score, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentLowestReputerScoreResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCurrentLowestReputerScoreResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryCurrentLowestReputerScoreResponse {
    return { score: isSet(object.score) ? Score.fromJSON(object.score) : undefined };
  },

  toJSON(message: QueryCurrentLowestReputerScoreResponse): unknown {
    const obj: any = {};
    if (message.score !== undefined) {
      obj.score = Score.toJSON(message.score);
    }
  ...
  create(base?: DeepPartial<QueryCurrentLowestReputerScoreResponse>): QueryCurrentLowestReputerScoreResponse {
    return QueryCurrentLowestReputerScoreResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryCurrentLowestReputerScoreResponse>): QueryCurrentLowestReputerScoreResponse {
    const message = createBaseQueryCurrentLowestReputerScoreResponse();
    message.score = (object.score !== undefined && object.score !== null) ? Score.fromPartial(object.score) : undefined;
    return message;
  },
...
function createBaseQueryActiveTopicsAtBlockRequest(): QueryActiveTopicsAtBlockRequest {
  return { blockHeight: "0" };
}

export const QueryActiveTopicsAtBlockRequest: MessageFns<QueryActiveTopicsAtBlockRequest> = {
  encode(message: QueryActiveTopicsAtBlockRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.blockHeight !== "0") {
      writer.uint32(8).int64(message.blockHeight);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryActiveTopicsAtBlockRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryActiveTopicsAtBlockRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryActiveTopicsAtBlockRequest {
    return { blockHeight: isSet(object.blockHeight) ? globalThis.String(object.blockHeight) : "0" };
  },

  toJSON(message: QueryActiveTopicsAtBlockRequest): unknown {
    const obj: any = {};
    if (message.blockHeight !== "0") {
      obj.blockHeight = message.blockHeight;
    }
  ...
  create(base?: DeepPartial<QueryActiveTopicsAtBlockRequest>): QueryActiveTopicsAtBlockRequest {
    return QueryActiveTopicsAtBlockRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryActiveTopicsAtBlockRequest>): QueryActiveTopicsAtBlockRequest {
    const message = createBaseQueryActiveTopicsAtBlockRequest();
    message.blockHeight = object.blockHeight ?? "0";
    return message;
  },
...
function createBaseQueryActiveTopicsAtBlockResponse(): QueryActiveTopicsAtBlockResponse {
  return { topics: [], pagination: undefined };
}

export const QueryActiveTopicsAtBlockResponse: MessageFns<QueryActiveTopicsAtBlockResponse> = {
  encode(message: QueryActiveTopicsAtBlockResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.topics) {
      Topic.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryActiveTopicsAtBlockResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryActiveTopicsAtBlockResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryActiveTopicsAtBlockResponse {
    return {
      topics: globalThis.Array.isArray(object?.topics) ? object.topics.map((e: any) => Topic.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? SimpleCursorPaginationResponse.fromJSON(object.pagination) : undefined,
    };
  ...
  toJSON(message: QueryActiveTopicsAtBlockResponse): unknown {
    const obj: any = {};
    if (message.topics?.length) {
      obj.topics = message.topics.map((e) => Topic.toJSON(e));
    }
  ...
  create(base?: DeepPartial<QueryActiveTopicsAtBlockResponse>): QueryActiveTopicsAtBlockResponse {
    return QueryActiveTopicsAtBlockResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryActiveTopicsAtBlockResponse>): QueryActiveTopicsAtBlockResponse {
    const message = createBaseQueryActiveTopicsAtBlockResponse();
    message.topics = object.topics?.map((e) => Topic.fromPartial(e)) || [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? SimpleCursorPaginationResponse.fromPartial(object.pagination)
...
function createBaseQueryNextChurningBlockByTopicIdRequest(): QueryNextChurningBlockByTopicIdRequest {
  return { topicId: "0" };
}

export const QueryNextChurningBlockByTopicIdRequest: MessageFns<QueryNextChurningBlockByTopicIdRequest> = {
  encode(message: QueryNextChurningBlockByTopicIdRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryNextChurningBlockByTopicIdRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryNextChurningBlockByTopicIdRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryNextChurningBlockByTopicIdRequest {
    return { topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0" };
  },

  toJSON(message: QueryNextChurningBlockByTopicIdRequest): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<QueryNextChurningBlockByTopicIdRequest>): QueryNextChurningBlockByTopicIdRequest {
    return QueryNextChurningBlockByTopicIdRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryNextChurningBlockByTopicIdRequest>): QueryNextChurningBlockByTopicIdRequest {
    const message = createBaseQueryNextChurningBlockByTopicIdRequest();
    message.topicId = object.topicId ?? "0";
    return message;
  },
...
function createBaseQueryNextChurningBlockByTopicIdResponse(): QueryNextChurningBlockByTopicIdResponse {
  return { blockHeight: "0" };
}

export const QueryNextChurningBlockByTopicIdResponse: MessageFns<QueryNextChurningBlockByTopicIdResponse> = {
  encode(message: QueryNextChurningBlockByTopicIdResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.blockHeight !== "0") {
      writer.uint32(8).int64(message.blockHeight);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryNextChurningBlockByTopicIdResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryNextChurningBlockByTopicIdResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryNextChurningBlockByTopicIdResponse {
    return { blockHeight: isSet(object.blockHeight) ? globalThis.String(object.blockHeight) : "0" };
  },

  toJSON(message: QueryNextChurningBlockByTopicIdResponse): unknown {
    const obj: any = {};
    if (message.blockHeight !== "0") {
      obj.blockHeight = message.blockHeight;
    }
  ...
  create(base?: DeepPartial<QueryNextChurningBlockByTopicIdResponse>): QueryNextChurningBlockByTopicIdResponse {
    return QueryNextChurningBlockByTopicIdResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QueryNextChurningBlockByTopicIdResponse>): QueryNextChurningBlockByTopicIdResponse {
    const message = createBaseQueryNextChurningBlockByTopicIdResponse();
    message.blockHeight = object.blockHeight ?? "0";
    return message;
  },
...
export interface Query {
  ...
  GetLatestAvailableNetworkInference(
    request: QueryLatestAvailableNetworkInferencesRequest,
  ): Promise<QueryLatestAvailableNetworkInferencesResponse>;
  ...
  GetTopicLastWorkerCommitInfo(
    request: QueryTopicLastWorkerCommitInfoRequest,
  ): Promise<QueryTopicLastWorkerCommitInfoResponse>;
  GetTopicLastReputerCommitInfo(
    request: QueryTopicLastReputerCommitInfoRequest,
  ): Promise<QueryTopicLastReputerCommitInfoResponse>;
  ...
  GetPreviousTopicQuantileForecasterScoreEma(
    request: QueryGetPreviousTopicQuantileForecasterScoreEmaRequest,
  ): Promise<QueryGetPreviousTopicQuantileForecasterScoreEmaResponse>;
  GetPreviousTopicQuantileInfererScoreEma(
    request: QueryGetPreviousTopicQuantileInfererScoreEmaRequest,
  ): Promise<QueryGetPreviousTopicQuantileInfererScoreEmaResponse>;
  GetPreviousTopicQuantileReputerScoreEma(
    request: QueryGetPreviousTopicQuantileReputerScoreEmaRequest,
  ): Promise<QueryGetPreviousTopicQuantileReputerScoreEmaResponse>;
  ...
  GetCurrentLowestInfererScore(
    request: QueryCurrentLowestInfererScoreRequest,
  ): Promise<QueryCurrentLowestInfererScoreResponse>;
  ...
  GetCurrentLowestForecasterScore(
    request: QueryCurrentLowestForecasterScoreRequest,
  ): Promise<QueryCurrentLowestForecasterScoreResponse>;
  ...
  GetCurrentLowestReputerScore(
    request: QueryCurrentLowestReputerScoreRequest,
  ): Promise<QueryCurrentLowestReputerScoreResponse>;
  ...
  GetNextChurningBlockByTopicId(
    request: QueryNextChurningBlockByTopicIdRequest,
  ): Promise<QueryNextChurningBlockByTopicIdResponse>;
}

export const QueryServiceName = "emissions.v3.Query";
export class QueryClientImpl implements Query {
  ...
  GetLatestAvailableNetworkInference(
    ...
    const data = QueryLatestAvailableNetworkInferencesRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetLatestAvailableNetworkInference", data);
    return promise.then((data) => QueryLatestAvailableNetworkInferencesResponse.decode(new BinaryReader(data)));
  }
  ...
  GetTopicLastWorkerCommitInfo(
    ...
    const data = QueryTopicLastWorkerCommitInfoRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTopicLastWorkerCommitInfo", data);
    return promise.then((data) => QueryTopicLastWorkerCommitInfoResponse.decode(new BinaryReader(data)));
  }

  GetTopicLastReputerCommitInfo(
    request: QueryTopicLastReputerCommitInfoRequest,
  ): Promise<QueryTopicLastReputerCommitInfoResponse> {
    const data = QueryTopicLastReputerCommitInfoRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTopicLastReputerCommitInfo", data);
    return promise.then((data) => QueryTopicLastReputerCommitInfoResponse.decode(new BinaryReader(data)));
  }
  ...
  GetInfererScoreEma(request: QueryGetInfererScoreEmaRequest): Promise<QueryGetInfererScoreEmaResponse> {
    const data = QueryGetInfererScoreEmaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetInfererScoreEma", data);
    return promise.then((data) => QueryGetInfererScoreEmaResponse.decode(new BinaryReader(data)));
  }

  GetForecasterScoreEma(request: QueryGetForecasterScoreEmaRequest): Promise<QueryGetForecasterScoreEmaResponse> {
    const data = QueryGetForecasterScoreEmaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetForecasterScoreEma", data);
    return promise.then((data) => QueryGetForecasterScoreEmaResponse.decode(new BinaryReader(data)));
  }

  GetReputerScoreEma(request: QueryGetReputerScoreEmaRequest): Promise<QueryGetReputerScoreEmaResponse> {
    const data = QueryGetReputerScoreEmaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetReputerScoreEma", data);
    return promise.then((data) => QueryGetReputerScoreEmaResponse.decode(new BinaryReader(data)));
  }
  ...
  GetPreviousTopicQuantileForecasterScoreEma(
    ...
    const data = QueryGetPreviousTopicQuantileForecasterScoreEmaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetPreviousTopicQuantileForecasterScoreEma", data);
    return promise.then((data) =>
      QueryGetPreviousTopicQuantileForecasterScoreEmaResponse.decode(new BinaryReader(data))
    );
  }
  ...
  GetPreviousTopicQuantileInfererScoreEma(
    ...
    const data = QueryGetPreviousTopicQuantileInfererScoreEmaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetPreviousTopicQuantileInfererScoreEma", data);
    return promise.then((data) => QueryGetPreviousTopicQuantileInfererScoreEmaResponse.decode(new BinaryReader(data)));
  }

  GetPreviousTopicQuantileReputerScoreEma(
    request: QueryGetPreviousTopicQuantileReputerScoreEmaRequest,
  ): Promise<QueryGetPreviousTopicQuantileReputerScoreEmaResponse> {
    const data = QueryGetPreviousTopicQuantileReputerScoreEmaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetPreviousTopicQuantileReputerScoreEma", data);
    return promise.then((data) => QueryGetPreviousTopicQuantileReputerScoreEmaResponse.decode(new BinaryReader(data)));
  }
  ...
  GetCurrentLowestInfererScore(
    ...
    const data = QueryCurrentLowestInfererScoreRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetCurrentLowestInfererScore", data);
    return promise.then((data) => QueryCurrentLowestInfererScoreResponse.decode(new BinaryReader(data)));
  }
  ...
  GetCurrentLowestForecasterScore(
    ...
    const data = QueryCurrentLowestForecasterScoreRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetCurrentLowestForecasterScore", data);
    return promise.then((data) => QueryCurrentLowestForecasterScoreResponse.decode(new BinaryReader(data)));
  }
  ...
  GetCurrentLowestReputerScore(
    ...
    const data = QueryCurrentLowestReputerScoreRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetCurrentLowestReputerScore", data);
    return promise.then((data) => QueryCurrentLowestReputerScoreResponse.decode(new BinaryReader(data)));
  }
  ...
  GetActiveTopicsAtBlock(request: QueryActiveTopicsAtBlockRequest): Promise<QueryActiveTopicsAtBlockResponse> {
    const data = QueryActiveTopicsAtBlockRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetActiveTopicsAtBlock", data);
    return promise.then((data) => QueryActiveTopicsAtBlockResponse.decode(new BinaryReader(data)));
  }

  GetNextChurningBlockByTopicId(
    request: QueryNextChurningBlockByTopicIdRequest,
  ): Promise<QueryNextChurningBlockByTopicIdResponse> {
    const data = QueryNextChurningBlockByTopicIdRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetNextChurningBlockByTopicId", data);
    return promise.then((data) => QueryNextChurningBlockByTopicIdResponse.decode(new BinaryReader(data)));
  }
}
