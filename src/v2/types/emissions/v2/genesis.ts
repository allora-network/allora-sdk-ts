...
//   protoc               unknown
// source: emissions/v2/genesis.proto
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.latestInfererScoresByWorker) {
      TopicIdActorIdScore.encode(v!, writer.uint32(106).fork()).join();
    }
    for (const v of message.latestForecasterScoresByWorker) {
      TopicIdActorIdScore.encode(v!, writer.uint32(114).fork()).join();
    }
    for (const v of message.latestReputerScoresByReputer) {
      TopicIdActorIdScore.encode(v!, writer.uint32(122).fork()).join();
    }
    ...
    for (const v of message.previousForecasterScoreRatio) {
      TopicIdActorIdDec.encode(v!, writer.uint32(162).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.latestInfererScoresByWorker.push(TopicIdActorIdScore.decode(reader, reader.uint32()));
          continue;
        }
        case 14: {
          if (tag !== 114) {
          ...
          message.latestForecasterScoresByWorker.push(TopicIdActorIdScore.decode(reader, reader.uint32()));
          continue;
        }
        case 15: {
          if (tag !== 122) {
          ...
          message.latestReputerScoresByReputer.push(TopicIdActorIdScore.decode(reader, reader.uint32()));
          continue;
        }
        case 16: {
          if (tag !== 130) {
        ...
        case 20: {
          ...
          message.previousForecasterScoreRatio.push(TopicIdActorIdDec.decode(reader, reader.uint32()));
          continue;
        }
        case 21: {
          if (tag !== 170) {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      reputerScoresByBlock: globalThis.Array.isArray(object?.reputerScoresByBlock)
        ...
        : [],
      latestInfererScoresByWorker: globalThis.Array.isArray(object?.latestInfererScoresByWorker)
        ? object.latestInfererScoresByWorker.map((e: any) => TopicIdActorIdScore.fromJSON(e))
        : [],
      latestForecasterScoresByWorker: globalThis.Array.isArray(object?.latestForecasterScoresByWorker)
        ? object.latestForecasterScoresByWorker.map((e: any) => TopicIdActorIdScore.fromJSON(e))
        : [],
      latestReputerScoresByReputer: globalThis.Array.isArray(object?.latestReputerScoresByReputer)
        ? object.latestReputerScoresByReputer.map((e: any) => TopicIdActorIdScore.fromJSON(e))
        : [],
      ...
      previousForecasterScoreRatio: globalThis.Array.isArray(object?.previousForecasterScoreRatio)
        ? object.previousForecasterScoreRatio.map((e: any) => TopicIdActorIdDec.fromJSON(e))
        : [],
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.latestInfererScoresByWorker?.length) {
      obj.latestInfererScoresByWorker = message.latestInfererScoresByWorker.map((e) => TopicIdActorIdScore.toJSON(e));
    }
    if (message.latestForecasterScoresByWorker?.length) {
      obj.latestForecasterScoresByWorker = message.latestForecasterScoresByWorker.map((e) =>
        TopicIdActorIdScore.toJSON(e)
      );
    }
    if (message.latestReputerScoresByReputer?.length) {
      obj.latestReputerScoresByReputer = message.latestReputerScoresByReputer.map((e) => TopicIdActorIdScore.toJSON(e));
    }
    ...
    if (message.previousForecasterScoreRatio?.length) {
      obj.previousForecasterScoreRatio = message.previousForecasterScoreRatio.map((e) => TopicIdActorIdDec.toJSON(e));
    }
    if (message.totalStake !== "") {
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    message.reputerScoresByBlock = object.reputerScoresByBlock?.map((e) => TopicIdBlockHeightScores.fromPartial(e)) ||
      [];
    message.latestInfererScoresByWorker =
      object.latestInfererScoresByWorker?.map((e) => TopicIdActorIdScore.fromPartial(e)) || [];
    message.latestForecasterScoresByWorker =
      object.latestForecasterScoresByWorker?.map((e) => TopicIdActorIdScore.fromPartial(e)) || [];
    message.latestReputerScoresByReputer =
      object.latestReputerScoresByReputer?.map((e) => TopicIdActorIdScore.fromPartial(e)) || [];
    ...
    message.previousForecasterScoreRatio =
      object.previousForecasterScoreRatio?.map((e) => TopicIdActorIdDec.fromPartial(e)) || [];
