...
export const Params: MessageFns<Params> = {
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    message.maxTopicsPerBlock = object.maxTopicsPerBlock ?? "0";
    ...
    message.maxRetriesToFulfilNoncesWorker = object.maxRetriesToFulfilNoncesWorker ?? "0";
    message.maxRetriesToFulfilNoncesReputer = object.maxRetriesToFulfilNoncesReputer ?? "0";
    ...
    message.topicFeeRevenueDecayRate = object.topicFeeRevenueDecayRate ?? "";
    message.epsilonReputer = object.epsilonReputer ?? "";
    message.minEffectiveTopicRevenue = object.minEffectiveTopicRevenue ?? "";
