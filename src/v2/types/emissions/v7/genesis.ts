...
export interface GenesisState {
  ...
  topicWorkerWhitelistEnabled: string[];
  topicReputerWhitelistEnabled: string[];
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.countInfererInclusionsInTopicActiveSet) {
      TopicIdActorIdUint64.encode(v!, writer.uint32(530).fork()).join();
    }
    for (const v of message.countForecasterInclusionsInTopicActiveSet) {
      TopicIdActorIdUint64.encode(v!, writer.uint32(538).fork()).join();
    }
    for (const v of message.activeInferers) {
      TopicAndActorId.encode(v!, writer.uint32(546).fork()).join();
    }
    for (const v of message.activeForecasters) {
      TopicAndActorId.encode(v!, writer.uint32(554).fork()).join();
    }
    for (const v of message.lowestInfererScoreEma) {
      TopicIdActorIdScore.encode(v!, writer.uint32(562).fork()).join();
    }
    for (const v of message.lowestForecasterScoreEma) {
      TopicIdActorIdScore.encode(v!, writer.uint32(570).fork()).join();
    }
    for (const v of message.activeReputers) {
      TopicAndActorId.encode(v!, writer.uint32(578).fork()).join();
    }
    for (const v of message.lowestReputerScoreEma) {
      TopicIdActorIdScore.encode(v!, writer.uint32(586).fork()).join();
    }
    for (const v of message.lossBundles) {
      TopicIdReputerReputerValueBundle.encode(v!, writer.uint32(594).fork()).join();
    }
    ...
    for (const v of message.topicWorkerWhitelist) {
      TopicAndActorId.encode(v!, writer.uint32(642).fork()).join();
    }
    for (const v of message.topicReputerWhitelist) {
      TopicAndActorId.encode(v!, writer.uint32(650).fork()).join();
    }
    ...
    for (const v of message.lastMedianInferences) {
      TopicIdAndDec.encode(v!, writer.uint32(674).fork()).join();
    }
    for (const v of message.madInferences) {
      TopicIdAndDec.encode(v!, writer.uint32(682).fork()).join();
    }
    for (const v of message.initialInfererEmaScore) {
      TopicIdAndDec.encode(v!, writer.uint32(690).fork()).join();
    }
    for (const v of message.initialForecasterEmaScore) {
      TopicIdAndDec.encode(v!, writer.uint32(698).fork()).join();
    }
    for (const v of message.initialReputerEmaScore) {
      TopicIdAndDec.encode(v!, writer.uint32(706).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 66: {
          ...
          message.countInfererInclusionsInTopicActiveSet.push(TopicIdActorIdUint64.decode(reader, reader.uint32()));
          continue;
        }
        case 67: {
          if (tag !== 538) {
          ...
          message.countForecasterInclusionsInTopicActiveSet.push(TopicIdActorIdUint64.decode(reader, reader.uint32()));
          continue;
        }
        case 68: {
          if (tag !== 546) {
          ...
          message.activeInferers.push(TopicAndActorId.decode(reader, reader.uint32()));
          continue;
        }
        case 69: {
          if (tag !== 554) {
          ...
          message.activeForecasters.push(TopicAndActorId.decode(reader, reader.uint32()));
          continue;
        }
        case 70: {
          if (tag !== 562) {
          ...
          message.lowestInfererScoreEma.push(TopicIdActorIdScore.decode(reader, reader.uint32()));
          continue;
        }
        case 71: {
          if (tag !== 570) {
          ...
          message.lowestForecasterScoreEma.push(TopicIdActorIdScore.decode(reader, reader.uint32()));
          continue;
        }
        case 72: {
          if (tag !== 578) {
          ...
          message.activeReputers.push(TopicAndActorId.decode(reader, reader.uint32()));
          continue;
        }
        case 73: {
          if (tag !== 586) {
          ...
          message.lowestReputerScoreEma.push(TopicIdActorIdScore.decode(reader, reader.uint32()));
          continue;
        }
        case 74: {
          if (tag !== 594) {
          ...
          message.lossBundles.push(TopicIdReputerReputerValueBundle.decode(reader, reader.uint32()));
          continue;
        }
        case 75: {
          if (tag !== 602) {
        ...
        case 80: {
          ...
          message.topicWorkerWhitelist.push(TopicAndActorId.decode(reader, reader.uint32()));
          continue;
        }
        case 81: {
          if (tag !== 650) {
          ...
          message.topicReputerWhitelist.push(TopicAndActorId.decode(reader, reader.uint32()));
          continue;
        }
        case 82: {
          if (tag === 656) {
        ...
        case 84: {
          ...
          message.lastMedianInferences.push(TopicIdAndDec.decode(reader, reader.uint32()));
          continue;
        }
        case 85: {
          if (tag !== 682) {
          ...
          message.madInferences.push(TopicIdAndDec.decode(reader, reader.uint32()));
          continue;
        }
        case 86: {
          if (tag !== 690) {
          ...
          message.initialInfererEmaScore.push(TopicIdAndDec.decode(reader, reader.uint32()));
          continue;
        }
        case 87: {
          if (tag !== 698) {
          ...
          message.initialForecasterEmaScore.push(TopicIdAndDec.decode(reader, reader.uint32()));
          continue;
        }
        case 88: {
          if (tag !== 706) {
          ...
          message.initialReputerEmaScore.push(TopicIdAndDec.decode(reader, reader.uint32()));
          continue;
        }
        case 89: {
          if (tag !== 714) {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      previousTopicQuantileReputerScoreEma: globalThis.Array.isArray(object?.previousTopicQuantileReputerScoreEma)
        ...
        : [],
      countInfererInclusionsInTopicActiveSet: globalThis.Array.isArray(object?.countInfererInclusionsInTopicActiveSet)
        ? object.countInfererInclusionsInTopicActiveSet.map((e: any) => TopicIdActorIdUint64.fromJSON(e))
        : [],
      countForecasterInclusionsInTopicActiveSet:
        globalThis.Array.isArray(object?.countForecasterInclusionsInTopicActiveSet)
          ? object.countForecasterInclusionsInTopicActiveSet.map((e: any) => TopicIdActorIdUint64.fromJSON(e))
          : [],
      activeInferers: globalThis.Array.isArray(object?.activeInferers)
        ? object.activeInferers.map((e: any) => TopicAndActorId.fromJSON(e))
        : [],
      activeForecasters: globalThis.Array.isArray(object?.activeForecasters)
        ? object.activeForecasters.map((e: any) => TopicAndActorId.fromJSON(e))
        : [],
      lowestInfererScoreEma: globalThis.Array.isArray(object?.lowestInfererScoreEma)
        ? object.lowestInfererScoreEma.map((e: any) => TopicIdActorIdScore.fromJSON(e))
        : [],
      lowestForecasterScoreEma: globalThis.Array.isArray(object?.lowestForecasterScoreEma)
        ? object.lowestForecasterScoreEma.map((e: any) => TopicIdActorIdScore.fromJSON(e))
        : [],
      activeReputers: globalThis.Array.isArray(object?.activeReputers)
        ? object.activeReputers.map((e: any) => TopicAndActorId.fromJSON(e))
        : [],
      lowestReputerScoreEma: globalThis.Array.isArray(object?.lowestReputerScoreEma)
        ? object.lowestReputerScoreEma.map((e: any) => TopicIdActorIdScore.fromJSON(e))
        : [],
      lossBundles: globalThis.Array.isArray(object?.lossBundles)
        ? object.lossBundles.map((e: any) => TopicIdReputerReputerValueBundle.fromJSON(e))
        : [],
      ...
      rewardCurrentBlockEmission: isSet(object.rewardCurrentBlockEmission)
        ...
        : "",
      whitelistAdmins: globalThis.Array.isArray(object?.whitelistAdmins)
        ? object.whitelistAdmins.map((e: any) => globalThis.String(e))
        : [],
      globalWhitelist: globalThis.Array.isArray(object?.globalWhitelist)
        ? object.globalWhitelist.map((e: any) => globalThis.String(e))
        : [],
      topicCreatorWhitelist: globalThis.Array.isArray(object?.topicCreatorWhitelist)
        ? object.topicCreatorWhitelist.map((e: any) => globalThis.String(e))
        : [],
      topicWorkerWhitelist: globalThis.Array.isArray(object?.topicWorkerWhitelist)
        ? object.topicWorkerWhitelist.map((e: any) => TopicAndActorId.fromJSON(e))
        : [],
      topicReputerWhitelist: globalThis.Array.isArray(object?.topicReputerWhitelist)
        ? object.topicReputerWhitelist.map((e: any) => TopicAndActorId.fromJSON(e))
        : [],
      topicWorkerWhitelistEnabled: globalThis.Array.isArray(object?.topicWorkerWhitelistEnabled)
        ? object.topicWorkerWhitelistEnabled.map((e: any) => globalThis.String(e))
        : [],
      topicReputerWhitelistEnabled: globalThis.Array.isArray(object?.topicReputerWhitelistEnabled)
        ? object.topicReputerWhitelistEnabled.map((e: any) => globalThis.String(e))
        : [],
      lastMedianInferences: globalThis.Array.isArray(object?.lastMedianInferences)
        ? object.lastMedianInferences.map((e: any) => TopicIdAndDec.fromJSON(e))
        : [],
      madInferences: globalThis.Array.isArray(object?.madInferences)
        ? object.madInferences.map((e: any) => TopicIdAndDec.fromJSON(e))
        : [],
      initialInfererEmaScore: globalThis.Array.isArray(object?.initialInfererEmaScore)
        ? object.initialInfererEmaScore.map((e: any) => TopicIdAndDec.fromJSON(e))
        : [],
      initialForecasterEmaScore: globalThis.Array.isArray(object?.initialForecasterEmaScore)
        ? object.initialForecasterEmaScore.map((e: any) => TopicIdAndDec.fromJSON(e))
        : [],
      initialReputerEmaScore: globalThis.Array.isArray(object?.initialReputerEmaScore)
        ? object.initialReputerEmaScore.map((e: any) => TopicIdAndDec.fromJSON(e))
        : [],
      globalWorkerWhitelist: globalThis.Array.isArray(object?.globalWorkerWhitelist)
        ? object.globalWorkerWhitelist.map((e: any) => globalThis.String(e))
        : [],
      globalReputerWhitelist: globalThis.Array.isArray(object?.globalReputerWhitelist)
        ? object.globalReputerWhitelist.map((e: any) => globalThis.String(e))
        : [],
      globalAdminWhitelist: globalThis.Array.isArray(object?.globalAdminWhitelist)
        ? object.globalAdminWhitelist.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.countInfererInclusionsInTopicActiveSet?.length) {
      obj.countInfererInclusionsInTopicActiveSet = message.countInfererInclusionsInTopicActiveSet.map((e) =>
        TopicIdActorIdUint64.toJSON(e)
      );
    }
    if (message.countForecasterInclusionsInTopicActiveSet?.length) {
      obj.countForecasterInclusionsInTopicActiveSet = message.countForecasterInclusionsInTopicActiveSet.map((e) =>
        TopicIdActorIdUint64.toJSON(e)
      );
    }
    if (message.activeInferers?.length) {
      obj.activeInferers = message.activeInferers.map((e) => TopicAndActorId.toJSON(e));
    }
    if (message.activeForecasters?.length) {
      obj.activeForecasters = message.activeForecasters.map((e) => TopicAndActorId.toJSON(e));
    }
    if (message.lowestInfererScoreEma?.length) {
      obj.lowestInfererScoreEma = message.lowestInfererScoreEma.map((e) => TopicIdActorIdScore.toJSON(e));
    }
    if (message.lowestForecasterScoreEma?.length) {
      obj.lowestForecasterScoreEma = message.lowestForecasterScoreEma.map((e) => TopicIdActorIdScore.toJSON(e));
    }
    if (message.activeReputers?.length) {
      obj.activeReputers = message.activeReputers.map((e) => TopicAndActorId.toJSON(e));
    }
    if (message.lowestReputerScoreEma?.length) {
      obj.lowestReputerScoreEma = message.lowestReputerScoreEma.map((e) => TopicIdActorIdScore.toJSON(e));
    }
    if (message.lossBundles?.length) {
      obj.lossBundles = message.lossBundles.map((e) => TopicIdReputerReputerValueBundle.toJSON(e));
    }
    if (message.totalSumPreviousTopicWeights !== "") {
    ...
    if (message.whitelistAdmins?.length) {
      obj.whitelistAdmins = message.whitelistAdmins;
    }
    if (message.globalWhitelist?.length) {
      obj.globalWhitelist = message.globalWhitelist;
    }
    if (message.topicCreatorWhitelist?.length) {
      obj.topicCreatorWhitelist = message.topicCreatorWhitelist;
    }
    if (message.topicWorkerWhitelist?.length) {
      obj.topicWorkerWhitelist = message.topicWorkerWhitelist.map((e) => TopicAndActorId.toJSON(e));
    }
    if (message.topicReputerWhitelist?.length) {
      obj.topicReputerWhitelist = message.topicReputerWhitelist.map((e) => TopicAndActorId.toJSON(e));
    }
    if (message.topicWorkerWhitelistEnabled?.length) {
      obj.topicWorkerWhitelistEnabled = message.topicWorkerWhitelistEnabled;
    }
    if (message.topicReputerWhitelistEnabled?.length) {
      obj.topicReputerWhitelistEnabled = message.topicReputerWhitelistEnabled;
    }
    if (message.lastMedianInferences?.length) {
      obj.lastMedianInferences = message.lastMedianInferences.map((e) => TopicIdAndDec.toJSON(e));
    }
    if (message.madInferences?.length) {
      obj.madInferences = message.madInferences.map((e) => TopicIdAndDec.toJSON(e));
    }
    if (message.initialInfererEmaScore?.length) {
      obj.initialInfererEmaScore = message.initialInfererEmaScore.map((e) => TopicIdAndDec.toJSON(e));
    }
    if (message.initialForecasterEmaScore?.length) {
      obj.initialForecasterEmaScore = message.initialForecasterEmaScore.map((e) => TopicIdAndDec.toJSON(e));
    }
    if (message.initialReputerEmaScore?.length) {
      obj.initialReputerEmaScore = message.initialReputerEmaScore.map((e) => TopicIdAndDec.toJSON(e));
    }
    if (message.globalWorkerWhitelist?.length) {
      obj.globalWorkerWhitelist = message.globalWorkerWhitelist;
    }
    if (message.globalReputerWhitelist?.length) {
      obj.globalReputerWhitelist = message.globalReputerWhitelist;
    }
    if (message.globalAdminWhitelist?.length) {
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    message.countInfererInclusionsInTopicActiveSet =
      object.countInfererInclusionsInTopicActiveSet?.map((e) => TopicIdActorIdUint64.fromPartial(e)) || [];
    message.countForecasterInclusionsInTopicActiveSet =
      object.countForecasterInclusionsInTopicActiveSet?.map((e) => TopicIdActorIdUint64.fromPartial(e)) || [];
    message.activeInferers = object.activeInferers?.map((e) => TopicAndActorId.fromPartial(e)) || [];
    message.activeForecasters = object.activeForecasters?.map((e) => TopicAndActorId.fromPartial(e)) || [];
    message.lowestInfererScoreEma = object.lowestInfererScoreEma?.map((e) => TopicIdActorIdScore.fromPartial(e)) || [];
    message.lowestForecasterScoreEma =
      object.lowestForecasterScoreEma?.map((e) => TopicIdActorIdScore.fromPartial(e)) || [];
    message.activeReputers = object.activeReputers?.map((e) => TopicAndActorId.fromPartial(e)) || [];
    message.lowestReputerScoreEma = object.lowestReputerScoreEma?.map((e) => TopicIdActorIdScore.fromPartial(e)) || [];
    message.lossBundles = object.lossBundles?.map((e) => TopicIdReputerReputerValueBundle.fromPartial(e)) || [];
    message.totalSumPreviousTopicWeights = object.totalSumPreviousTopicWeights ?? "";
    message.rewardCurrentBlockEmission = object.rewardCurrentBlockEmission ?? "";
    message.whitelistAdmins = object.whitelistAdmins?.map((e) => e) || [];
    message.globalWhitelist = object.globalWhitelist?.map((e) => e) || [];
    message.topicCreatorWhitelist = object.topicCreatorWhitelist?.map((e) => e) || [];
    message.topicWorkerWhitelist = object.topicWorkerWhitelist?.map((e) => TopicAndActorId.fromPartial(e)) || [];
    message.topicReputerWhitelist = object.topicReputerWhitelist?.map((e) => TopicAndActorId.fromPartial(e)) || [];
    message.topicWorkerWhitelistEnabled = object.topicWorkerWhitelistEnabled?.map((e) => e) || [];
    message.topicReputerWhitelistEnabled = object.topicReputerWhitelistEnabled?.map((e) => e) || [];
    message.lastMedianInferences = object.lastMedianInferences?.map((e) => TopicIdAndDec.fromPartial(e)) || [];
    message.madInferences = object.madInferences?.map((e) => TopicIdAndDec.fromPartial(e)) || [];
    message.initialInfererEmaScore = object.initialInfererEmaScore?.map((e) => TopicIdAndDec.fromPartial(e)) || [];
    message.initialForecasterEmaScore = object.initialForecasterEmaScore?.map((e) => TopicIdAndDec.fromPartial(e)) ||
      [];
    message.initialReputerEmaScore = object.initialReputerEmaScore?.map((e) => TopicIdAndDec.fromPartial(e)) || [];
    message.globalWorkerWhitelist = object.globalWorkerWhitelist?.map((e) => e) || [];
    message.globalReputerWhitelist = object.globalReputerWhitelist?.map((e) => e) || [];
    message.globalAdminWhitelist = object.globalAdminWhitelist?.map((e) => e) || [];
    return message;
  },
};
...
function createBaseTopicIdActorIdUint64(): TopicIdActorIdUint64 {
  return { topicId: "0", actorId: "", uint64: "0" };
}

export const TopicIdActorIdUint64: MessageFns<TopicIdActorIdUint64> = {
  encode(message: TopicIdActorIdUint64, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.actorId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TopicIdActorIdUint64 {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TopicIdActorIdUint64 {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      actorId: isSet(object.actorId) ? globalThis.String(object.actorId) : "",
  ...
  toJSON(message: TopicIdActorIdUint64): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<TopicIdActorIdUint64>): TopicIdActorIdUint64 {
    return TopicIdActorIdUint64.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TopicIdActorIdUint64>): TopicIdActorIdUint64 {
    const message = createBaseTopicIdActorIdUint64();
    message.topicId = object.topicId ?? "0";
    message.actorId = object.actorId ?? "";
...
function createBaseTopicIdReputerReputerValueBundle(): TopicIdReputerReputerValueBundle {
  return { topicId: "0", reputer: "", reputerValueBundle: undefined };
}

export const TopicIdReputerReputerValueBundle: MessageFns<TopicIdReputerReputerValueBundle> = {
  encode(message: TopicIdReputerReputerValueBundle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.topicId !== "0") {
      writer.uint32(8).uint64(message.topicId);
    }
    if (message.reputer !== "") {
    ...
    if (message.reputerValueBundle !== undefined) {
      ReputerValueBundle.encode(message.reputerValueBundle, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TopicIdReputerReputerValueBundle {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TopicIdReputerReputerValueBundle {
    return {
      topicId: isSet(object.topicId) ? globalThis.String(object.topicId) : "0",
      reputer: isSet(object.reputer) ? globalThis.String(object.reputer) : "",
  ...
  toJSON(message: TopicIdReputerReputerValueBundle): unknown {
    const obj: any = {};
    if (message.topicId !== "0") {
      obj.topicId = message.topicId;
    }
  ...
  create(base?: DeepPartial<TopicIdReputerReputerValueBundle>): TopicIdReputerReputerValueBundle {
    return TopicIdReputerReputerValueBundle.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TopicIdReputerReputerValueBundle>): TopicIdReputerReputerValueBundle {
    const message = createBaseTopicIdReputerReputerValueBundle();
    message.topicId = object.topicId ?? "0";
    message.reputer = object.reputer ?? "";
